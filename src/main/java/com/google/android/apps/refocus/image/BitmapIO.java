...
public class BitmapIO {
    ...
    public static final String TAG = bli.m887a("BitmapIO");
    ...
    public static Bitmap decodeJpeg(byte[] bArr) {
        ...
        isx a = isx.m4219a(bArr);
        return a != null ? BitmapProcessing.rotate(decodeByteArray, isx.m4216a(a).f7692e) : decodeByteArray;
    }
