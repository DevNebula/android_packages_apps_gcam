...
public class RGBZViewer$RenderProgress implements ProgressCallback {
    ...
    public final /* synthetic */ icu f12912xc6d1e7de;
    public boolean wasCancelled;

    private RGBZViewer$RenderProgress(icu icu) {
        this.f12912xc6d1e7de = icu;
        this.wasCancelled = false;
    }

    public /* synthetic */ RGBZViewer$RenderProgress(icu icu, hsr hsr) {
        this(icu);
    }
    ...
    public void setProgress(float f) {
        if (this.f12912xc6d1e7de.f20904o != null) {
            this.f12912xc6d1e7de.f20904o.onProgress(f);
        }
    }
