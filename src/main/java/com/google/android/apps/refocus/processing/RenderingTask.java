...
public class RenderingTask implements gex {
    ...
    public static final String TAG = bli.m887a("RenderingTask");
    public ProgressCallback callback;
    public final glm captureSessionListener = new C06541();
    ...
    public RenderingTask(Uri uri, FocusSettings focusSettings, RGBZ rgbz, String str, Location location, FaceDetector faceDetector, ContentResolver contentResolver, gnu gnu, gnf gnf) {
        ...
        if (focusSettings == null) {
            bli.m888a(TAG, "No focus settings supplied, using default");
        ...
        gnf gnf2 = gnf;
        this.session = gnf2.mo7241a(getName(), kbg.m4803b(getLocation()), System.currentTimeMillis(), new goe(gnu, "TEMP_SESSIONS", getName()));
    ...
    public void process(Context context) {
        ...
        ken a = ken.m13713a(this.finishedCallback);
        int size = a.size();
        int i = 0;
        while (i < size) {
            int i2 = i + 1;
    ...
    private void processInternal(Context context, gmz gmz) {
        ...
        if (this.rgbz.hasDepthmap()) {
            gmz.mo15545a(this.uri, hci.m11979a((int) R.string.processing_notification, new Object[0]), glw.LENS_BLUR_RERENDER);
            ...
            if (this.location != null) {
                new itg(createRgbzFile.exif).mo8999a(this.location);
            }
            glx.m11389a((get) gmz, createRgbzFile.fileData, this.rgbz.getWidth(), this.rgbz.getHeight(), 0, createRgbzFile.exif);
        }
    }
