...
/* compiled from: PG */
public class RGBZ {
    public static final String TAG = bli.m887a("RGBZ");
    ...
    public RGBZ(Uri uri, ContentResolver contentResolver) {
        ...
        try {
            ...
            try {
                this.exif.mo12672a(openInputStream);
    ...
    private void finishParsingXMPMeta() {
        ...
        if (inputStream != null) {
            C0556wd extractXMPMeta = XmpUtil.extractXMPMeta(inputStream);
            try {
            ...
            this.imageData = hry.m3376a(extractXMPMeta);
            hry hry = this.imageData;
            if (hry != null) {
                byte[] bArr = hry.f6899b;
                if (bArr != null) {
                    bitmap = BitmapFactory.decodeByteArray(bArr, 0, bArr.length);
                }
                this.bitmap = bitmap;
            }
            this.depthmapData = hrw.m3372a(extractXMPMeta);
            hrw hrw = this.depthmapData;
            if (hrw != null) {
                this.depthTransform = hrw.f6896c;
                Bitmap bitmap2 = this.bitmap;
                if (!(hrw.f6895b == null || bitmap2 == null)) {
                    if (GDepthUtil.MIME_JPEG.equals(hrw.f6894a)) {
                        BitmapNative.decodeJPEGToChannel(hrw.f6895b, bitmap2, 3);
                    } else {
                        byte[] bArr2 = hrw.f6895b;
            ...
            hrx a = hrx.m3374a(extractXMPMeta);
            if (a != null) {
                this.focusSettings = a.f6897a;
            }
        }
    }
    ...
    private void writeXMPMeta(int i, ExifInterface exifInterface, OutputStream outputStream) {
        ...
        C0556wd createXMPMeta = XmpUtil.createXMPMeta();
        if (hasFocusSettings()) {
            hrx a = hrx.m3373a(getFocusSettings());
            hrx.m3375a();
            try {
                createXMPMeta.mo11442a("http://ns.google.com/photos/1.0/focus/", "BlurAtInfinity", Float.valueOf(a.f6897a.blurAtInfinity));
                createXMPMeta.mo11442a("http://ns.google.com/photos/1.0/focus/", "FocalDistance", Float.valueOf(a.f6897a.focalDistance));
                createXMPMeta.mo11442a("http://ns.google.com/photos/1.0/focus/", "DepthOfField", Float.valueOf(a.f6897a.depthOfField));
                createXMPMeta.mo11442a("http://ns.google.com/photos/1.0/focus/", "FocalPointX", Float.valueOf(a.f6897a.focalPointX));
                createXMPMeta.mo11442a("http://ns.google.com/photos/1.0/focus/", "FocalPointY", Float.valueOf(a.f6897a.focalPointY));
            } catch (Throwable e) {
                kqg.f8786a.mo10213b(e);
            }
        }
        C0556wd createXMPMeta2 = XmpUtil.createXMPMeta();
        if (this.imageData == null) {
            bli.m888a(TAG, "Encoding image data");
            Bitmap bitmap = this.bitmap;
            hry hry = new hry();
            hry.f6898a = GDepthUtil.MIME_JPEG;
            hry.f6899b = BitmapIO.toByteArray(bitmap, 85);
            this.imageData = hry;
        }
        ...
        if (hry2 != null) {
            hry.m3377a();
            try {
                createXMPMeta.mo11442a("http://ns.google.com/photos/1.0/image/", GDepthUtil.MIME, GDepthUtil.MIME_JPEG);
                createXMPMeta2.mo11448a("http://ns.google.com/photos/1.0/image/", "Data", hry2.f6899b);
            } catch (Throwable e2) {
        ...
        if (hasDepthmap()) {
            if (this.depthmapData == null) {
                bli.m888a(TAG, "Encoding depth data");
                this.depthmapData = hrw.m3371a(this);
            }
            hrw hrw = this.depthmapData;
            if (hrw != null) {
                GDepthUtil.initialize();
                try {
                    createXMPMeta.mo11442a(GDepthUtil.GOOGLE_DEPTH_NAMESPACE, GDepthUtil.FORMAT, hrw.f6896c.getFormat());
                    createXMPMeta.mo11440a(GDepthUtil.GOOGLE_DEPTH_NAMESPACE, GDepthUtil.NEAR, (double) hrw.f6896c.getNear());
                    createXMPMeta.mo11440a(GDepthUtil.GOOGLE_DEPTH_NAMESPACE, GDepthUtil.FAR, (double) hrw.f6896c.getFar());
                    createXMPMeta.mo11442a(GDepthUtil.GOOGLE_DEPTH_NAMESPACE, GDepthUtil.MIME, hrw.f6894a);
                    createXMPMeta2.mo11448a(GDepthUtil.GOOGLE_DEPTH_NAMESPACE, "Data", hrw.f6895b);
                } catch (Throwable e22) {
        ...
        if (hasDepthmap()) {
            ern.m2092a(createXMPMeta, bve.REFOCUS.mo2167d());
        } else {
            bli.m888a(TAG, "no depth map exists for current image");
        }
        if (!XmpUtil.writeXMPMeta(applyExif, outputStream, createXMPMeta, createXMPMeta2)) {
            bli.m891b(TAG, "failed to write xmp data");
        }
    }
}
