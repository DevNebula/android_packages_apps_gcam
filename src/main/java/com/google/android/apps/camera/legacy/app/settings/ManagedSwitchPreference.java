...
public class ManagedSwitchPreference extends SwitchPreference {
    ...
    public ManagedSwitchPreference(Context context) {
        super(context);
        ((cgt) context.getApplicationContext()).mo2290a().mo14594a(this);
    }
    ...
    /* renamed from: a */
    public static ManagedSwitchPreference m1315a(Context context, SwitchPreference switchPreference) {
    ...
    public boolean getPersistedBoolean(boolean z) {
        return this.f2557a.mo7293a("default_scope", getKey());
    }

    public boolean persistBoolean(boolean z) {
        this.f2557a.mo7298b("default_scope", getKey(), z);
        return true;
    }
}
