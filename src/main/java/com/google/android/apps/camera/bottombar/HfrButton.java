...
public class HfrButton extends him implements AnimatedImageButton {
    ...
    private void initialize() {
        setOnClickListener(new C00871());
        this.animator = ValueAnimator.ofInt(new int[]{0});
        this.animator.setDuration(0);
        this.backgroundPaint = new Paint();
        this.backgroundPaint.setColor(getColor(C0091R.color.hfr_button_background_color));
        this.backgroundPaint.setAntiAlias(true);
        this.rateTextPaint = createTextPaint(14);
        this.rateTextPaint.setColor(getColor(C0091R.color.hfr_button_text_color));
        this.fpsTextPaint = createTextPaint(12);
        this.fpsTextPaint.setColor(getColor(C0091R.color.hfr_button_text_color));
        this.fpsString = getResources().getString(C0091R.string.fps);
        this.rateStrings = getResources().getStringArray(C0091R.array.toybox_hfr_mode_rates);
        this.descriptionStrings = getResources().getStringArray(C0091R.array.toybox_hfr_mode_descriptions);
