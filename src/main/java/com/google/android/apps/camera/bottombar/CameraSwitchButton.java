...
public class CameraSwitchButton extends him implements AnimatedImageButton {
    ...
    class C00862 implements AnimatorUpdateListener {
        C00862() {
        }
    ...
    public CameraSwitchButton(Context context, AttributeSet attributeSet) {
        ...
        this.buttonColorLight = context.getColor(C0091R.color.front_back_switch_button_color);
    ...
    private void initialize() {
        ...
        setOnClickListener(new C00851());
        setFocusable(false);
        this.fastOutSlowInAnimator = ValueAnimator.ofFloat(new float[]{28.0f, 48.0f});
        this.fastOutSlowInAnimator.setDuration(500);
        this.fastOutSlowInAnimator.setInterpolator(new C0704ks());
        this.fastOutSlowInAnimator.addUpdateListener(new C00862());
    }
    ...
    private void setNewDescription() {
        CharSequence string;
        if (this.state == 1) {
            string = getResources().getString(C0091R.string.camera_id_front_desc);
        } else {
            string = getResources().getString(C0091R.string.camera_id_back_desc);
        }
