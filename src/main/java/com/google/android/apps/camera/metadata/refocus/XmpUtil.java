...
public class XmpUtil {
    ...
    public static C0556wd createXMPMeta() {
        return C0557we.m6180a();
    }

    public static C0556wd extractOrCreateXMPMeta(String str) {
        C0556wd extractXMPMeta = extractXMPMeta(str);
        return extractXMPMeta == null ? createXMPMeta() : extractXMPMeta;
    }

    public static C0556wd extractXMPMeta(InputStream inputStream) {
        return extractXMPMeta(inputStream, false);
    }

    public static C0556wd extractXMPMeta(InputStream inputStream, boolean z) {
        List parse = parse(inputStream, true, z);
        if (parse == null) {
            return null;
        }
        C0556wd parseFirstValidXMPSection = parseFirstValidXMPSection(parse);
        if (parseFirstValidXMPSection == null || !parseFirstValidXMPSection.mo11449b("http://ns.adobe.com/xmp/note/", XMP_HAS_EXTENSION)) {
            return parseFirstValidXMPSection;
        }
        try {
            String str = (String) parseFirstValidXMPSection.mo11452d("http://ns.adobe.com/xmp/note/", XMP_HAS_EXTENSION).mo11544a();
            if (!z) {
                C0556wd parseExtendedXMPSections = parseExtendedXMPSections(parse, str);
                if (parseExtendedXMPSections == null) {
                    return null;
                }
                try {
                    C0555wc a = parseExtendedXMPSections.mo11438a();
                    while (true) {
                        C0784xn c0784xn = (C0784xn) jri.m13404b(a.next());
                        String str2 = c0784xn.f22376b;
                        if (str2 != null) {
                            parseFirstValidXMPSection.mo11443a(c0784xn.f22375a, str2, c0784xn.f22377c, c0784xn.f22378d.mo11503d());
                        }
                    }
                } catch (Exception e) {
                    return parseFirstValidXMPSection;
    ...
    public static C0556wd extractXMPMeta(String str) {
    ...
    private static C0556wd parseExtendedXMPSections(List list, String str) {
        Section section;
        int length;
        int i = 0;
        StringBuilder stringBuilder = new StringBuilder(String.valueOf(str).length() + 36);
        ...
        for (Section section2 : list) {
            if (hasHeader(section2.data, stringBuilder2)) {
                length = stringBuilder2.length() + 7;
    ...
    private static C0556wd parseFirstValidXMPSection(List list) {
        for (Section section : list) {
    ...
    private static byte[] serializeMeta(C0556wd c0556wd) {
        try {
            C0783xk c0783xk = new C0783xk();
            c0783xk.mo14464f();
            c0783xk.mo14463e();
            return C0557we.m6183a(c0556wd, c0783xk);
        } catch (Throwable e) {
    ...
    public static boolean writeXMPMeta(InputStream inputStream, OutputStream outputStream, C0556wd c0556wd, C0556wd c0556wd2) {
        if (outputStream == null || c0556wd == null) {
            return false;
        }
        byte[] serializeMeta;
        OutputStream outputStream2 = (OutputStream) jri.m13404b((Object) outputStream);
        C0556wd c0556wd3 = (C0556wd) jri.m13404b((Object) c0556wd);
        if (c0556wd2 != null) {
            serializeMeta = serializeMeta(c0556wd2);
            if (serializeMeta == null) {
                return false;
            }
            try {
                c0556wd3.mo11442a("http://ns.adobe.com/xmp/note/", XMP_HAS_EXTENSION, getGUID(serializeMeta));
            } catch (Throwable e) {
        ...
        serializeMeta = null;
        byte[] serializeMeta2 = serializeMeta(c0556wd3);
        if (serializeMeta2 == null) {
            return false;
        }
        if (c0556wd2 != null) {
            c0556wd3.mo11439a("http://ns.adobe.com/xmp/note/", XMP_HAS_EXTENSION);
        }
    ...
    public static boolean writeXMPMeta(String str, C0556wd c0556wd) {
        ...
        try {
            boolean writeXMPMeta = writeXMPMeta(fileInputStream, fileOutputStream, c0556wd, null);
            try {
                fileOutputStream.close();
                return writeXMPMeta;
