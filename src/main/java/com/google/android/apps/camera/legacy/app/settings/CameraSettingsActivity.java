...
public class CameraSettingsActivity extends Activity {
    /* renamed from: a */
    private static final String f2555a = bli.m887a("SettingsActivity");
    /* renamed from: b */
    private dzl f2556b;
    ...
    public void onCreate(Bundle bundle) {
        ...
        ActionBar actionBar = (ActionBar) jri.m13404b(getActionBar());
        ...
        this.f2556b.setArguments(bundle2);
        getFragmentManager().beginTransaction().replace(R.id.settings_activity_content, this.f2556b).commit();
    }
    ...
    /* renamed from: b */
    private static void m1314b(irs irs, Preference preference) {
        if (!preference.getKey().equals("pref_category_developer")) {
            if (preference instanceof PreferenceGroup) {
                PreferenceGroup preferenceGroup = (PreferenceGroup) preference;
                for (int i = 0; i < preferenceGroup.getPreferenceCount(); i++) {
                    m1314b(irs, preferenceGroup.getPreference(i));
                }
