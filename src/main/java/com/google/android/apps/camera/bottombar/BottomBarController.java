...
public class BottomBarController {
    ...
    public final BottomBarListener listenerDispatcher = new C00844();
    ...
    class C00811 implements AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ((SmoothRotateSwitchButton) jqk.m13354c(BottomBarController.this.photoSwitchButton)).setTranslation(((Float) valueAnimator.getAnimatedValue()).floatValue());
        }
    }
    ...
    class C00844 extends BottomBarListener {
        C00844() {
        }
    ...
    public BottomBarController(BottomBar bottomBar, boolean z) {
        ...
        this.photoButtonFadeAnimator.setInterpolator(new C0704ks());
        this.photoButtonFadeAnimator.addUpdateListener(new C00811());
        this.photoButtonFadeAnimator.addListener(new C00822());
    }
