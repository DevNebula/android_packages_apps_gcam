...
public class RoundedThumbnailView extends him {
    ...
    public static final String TAG = bli.m887a("RoundedThumbnail");
    ...
    public final OnClickListener onClickListener = new C00941();
    ...
    class C00941 implements OnClickListener {
        ...
        class C00921 implements AnimatorUpdateListener {
            C00921() {
            }
        ...
        class C00932 extends AnimatorListenerAdapter {
            C00932() {
            }
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                if (RoundedThumbnailView.this.callback.mo9709b()) {
                    ((Callback) RoundedThumbnailView.this.callback.mo9706a()).onHitStateFinished();
                }
            }
        }
        ...
        public void onClick(View view) {
            ...
            ofFloat.addUpdateListener(new C00921());
            ofFloat.addListener(new C00932());
            ofFloat.start();
            if (RoundedThumbnailView.this.optionalOnClickListener.mo9709b()) {
                ((OnClickListener) RoundedThumbnailView.this.optionalOnClickListener.mo9706a()).onClick(view);
            }
        }
    }
    ...
    class C00963 implements AnimatorUpdateListener {
        C00963() {
        }
    ...
    class C00974 extends AnimatorListenerAdapter {
        C00974() {
        }
    ...
    class C00985 extends AnimatorListenerAdapter {
        C00985() {
        }
    ...
    class C00996 implements AnimatorUpdateListener {
        C00996() {
        }
    ...
    class C01007 implements AnimatorUpdateListener {
        C01007() {
        }
    ...
    class C01018 extends AnimatorListenerAdapter {
        C01018() {
        }
    ...
    /* synthetic */ class C01029 {
        /* renamed from: $SwitchMap$com$google$android$apps$camera$uiutils$TypedThumbnailBitmap$ThumbnailType */
        public static final /* synthetic */ int[] f2428x2330d0c4 = new int[hip.values().length];

        static {
            try {
                f2428x2330d0c4[hip.BURST.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f2428x2330d0c4[hip.PHOTO.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f2428x2330d0c4[hip.VIDEO.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f2428x2330d0c4[hip.SECURE.ordinal()] = 4;
    ...
    class RevealRequest {
        ...
        private void precomputeThumbnailPaint(Bitmap bitmap, int i) {
            ...
            bli.m896d(access$1600, stringBuilder.toString());
            if (this.thumbnailPaint == null && bitmap != null && bitmap.getWidth() == bitmap.getHeight()) {
                ...
                bli.m896d(RoundedThumbnailView.TAG, "precomputeThumbnailPaint finished");
            }
        }

        public void setThumbnailBitmap(Bitmap bitmap, int i) {
            if (bitmap.getWidth() != bitmap.getHeight()) {
                bitmap = hid.m3221a(hid.m3224b(bitmap));
            }
    ...
    class RoundedThumbnailOutlineProvider extends ViewOutlineProvider {
        ...
        /* synthetic */ RoundedThumbnailOutlineProvider(float f, RectF rectF, C00941 c00941) {
            this(f, rectF);
        }
    ...
    /* renamed from: flashThumbnail */
    public void m8374b() {
        bli.m896d(TAG, "flashThumbnail");
        ikd.m12501a();
    ...
    public Bitmap getDefaultThumbnail(hip hip) {
        ...
        bli.m896d(TAG, "showDefaultThumbnail");
        int i = (int) this.thumbnailShrinkDiameterEnd;
        Bitmap createBitmap = Bitmap.createBitmap(i, i, Config.ARGB_8888);
        createBitmap.eraseColor(getColor(C0091R.color.indicator_background));
        switch (hip.ordinal()) {
            case 1:
                drawable = getResources().getDrawable(C0091R.drawable.ic_camera_thumbnail, null);
                break;
            case 2:
                drawable = getResources().getDrawable(C0091R.drawable.ic_burst_thumbnail, null);
                break;
            case 3:
                drawable = getResources().getDrawable(C0091R.drawable.ic_videocam_thumbnail, null);
                break;
            case 4:
                drawable = getResources().getDrawable(C0091R.drawable.ic_secure_thumbnail, null);
                break;
        }
    ...
    private void initialize() {
        this.callback = kau.f21835a;
        this.optionalOnClickListener = kau.f21835a;
        setClickable(true);
        super.setOnClickListener(this.onClickListener);
        this.thumbnailPadding = getResources().getDimension(C0091R.dimen.rounded_thumbnail_padding);
        this.thumbnailStretchDiameterBegin = getResources().getDimension(C0091R.dimen.rounded_thumbnail_diameter_min);
        this.thumbnailStretchDiameterEnd = getResources().getDimension(C0091R.dimen.rounded_thumbnail_diameter_max);
        this.thumbnailShrinkDiameterBegin = this.thumbnailStretchDiameterEnd;
        this.thumbnailShrinkDiameterEnd = getResources().getDimension(C0091R.dimen.rounded_thumbnail_diameter_normal);
        this.thumbnailTypeIconSize = getResources().getDimension(C0091R.dimen.rounded_thumbnail_type_icon_size);
        this.rippleRingDiameterEnd = getResources().getDimension(C0091R.dimen.rounded_thumbnail_ripple_ring_diameter_max);
        float f = this.rippleRingDiameterEnd;
        this.viewRect = new RectF(0.0f, 0.0f, f, f);
        this.rippleRingDiameterBegin = getResources().getDimension(C0091R.dimen.rounded_thumbnail_ripple_ring_diameter_min);
        this.rippleRingThicknessBegin = getResources().getDimension(C0091R.dimen.rounded_thumbnail_ripple_ring_thick_max);
        this.rippleRingThicknessEnd = getResources().getDimension(C0091R.dimen.rounded_thumbnail_ripple_ring_thick_min);
        ...
        this.innerStrokeWidth = getResources().getDimension(C0091R.dimen.rounded_thumbnail_inner_stroke_width);
        this.borderStrokePaint.setStrokeWidth(this.innerStrokeWidth);
        f = 0.0f;
        float f2 = 0.0f;
        this.borderStrokePaint.setShader(new LinearGradient(0.0f, f, f2, this.thumbnailShrinkDiameterEnd, new int[]{getResources().getColor(C0091R.color.button_border_gradient_top, null), getResources().getColor(C0091R.color.button_border_gradient_bottom, null)}, null, TileMode.CLAMP));
        setOutlineProvider(new RoundedThumbnailOutlineProvider(this.thumbnailShrinkDiameterEnd, this.viewRect, null));
        setEnabled(false);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float f2 = this.rippleRingDiameterEnd;
        float f3 = this.thumbnailShrinkDiameterEnd;
        ...
        if (this.foregroundRequest != null) {
            ...
            f = this.currentThumbnailDiameter / this.rippleRingDiameterEnd;
            canvas.save();
            canvas.scale(f, f, width, height);
            thumbnailPaint = ((RevealRequest) jqk.m13354c(this.foregroundRequest)).getThumbnailPaint();
            if (thumbnailPaint != null) {
                canvas.drawRoundRect(this.viewRect, width, height, thumbnailPaint);
                canvas.drawCircle(width, height, width - (this.innerStrokeWidth / 2.0f), this.borderStrokePaint);
            }
    ...
    private void runBurstFlashAnimation() {
        bli.m896d(TAG, "runPendingFlashAnimation");
        RevealRequest revealRequest = this.foregroundRequest;
        if (revealRequest != null) {
        ...
        this.burstFlashAnimator.addUpdateListener(new C01007());
        this.burstFlashAnimator.addListener(new C01018());
        this.burstFlashAnimator.start();
    }

    private void runPendingRequestAnimation(boolean z) {
        bli.m896d(TAG, "runPendingRequestAnimation");
        int isAnimationDisabled = ((RevealRequest) jqk.m13354c(this.pendingRequest)).isAnimationDisabled() ^ 1;
        ...
        if (isAnimationDisabled == 0) {
            if (this.thumbnailAnimatorSet == null) {
                ...
                ((RevealRequest) jqk.m13354c(this.foregroundRequest)).finishThumbnailAnimation();
            }
            if (this.rippleAnimator == null) {
                ((RevealRequest) jqk.m13354c(this.foregroundRequest)).finishRippleAnimation();
            }
            invalidate();
            return;
        }
        ...
        ofFloat.addUpdateListener(new C00952());
        ...
        this.rippleAnimator.addListener(new C00985());
        this.rippleAnimator.addUpdateListener(new C00996());
        this.rippleAnimator.setStartDelay(100);
        this.rippleAnimator.start();
        announceForAccessibility(((RevealRequest) jqk.m13354c(this.foregroundRequest)).getAccessibilityString());
    }

    public void setCallback(Callback callback) {
        this.callback = kbg.m4804c(callback);
    }

    public void setOnClickListener(OnClickListener onClickListener) {
        this.optionalOnClickListener = kbg.m4803b(onClickListener);
    }
    ...
    public void startRevealThumbnailAnimation(String str) {
        bli.m896d(TAG, "startRevealThumbnailAnimation");
        ikd.m12501a();
    ...
    /* renamed from: stopFlashThumbnail */
    public void m8370a() {
        bli.m896d(TAG, "stopFlashThumbnail");
        ikd.m12501a();
