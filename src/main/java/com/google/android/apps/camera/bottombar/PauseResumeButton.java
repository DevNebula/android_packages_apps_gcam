...
public class PauseResumeButton extends ImageButton {
    public static final int[] STATE_PAUSED = new int[]{C0091R.attr.state_paused};
    ...
    public PauseResumeButton(Context context, AttributeSet attributeSet) {
        ...
        this.pauseResumeAnimatable = context.getResources().getDrawable(C0091R.drawable.ic_pause_resume_animation, null);
        this.resumePauseAnimatable = context.getResources().getDrawable(C0091R.drawable.ic_resume_pause_animation, null);
    }
    ...
    protected void transitionToPauseState() {
        ...
        this.isPaused = false;
        setContentDescription(getResources().getString(C0091R.string.pause_video_recording));
        refreshDrawableState();
    }
    ...
    protected void transitionToResumeState() {
        ...
        this.isPaused = true;
        setContentDescription(getResources().getString(C0091R.string.resume_video_recording));
        refreshDrawableState();
    }
}
