...
public class BottomBar extends LinearLayout {
    ...
    public BottomBar(Context context, AttributeSet attributeSet) {
        ...
        this.backgroundColor = context.getColor(C0091R.color.bottom_bar_background_color);
    ...
    float getPhotoVideoSwitchTranslation() {
        return (getResources().getDimension(C0091R.dimen.bottom_bar_content_size) + getResources().getDimension(C0091R.dimen.photo_video_switch_size)) / 2.0f;
    }
    ...
    private void inflate(Context context) {
        hkg a = hkg.m3276a(((LayoutInflater) context.getSystemService("layout_inflater")).inflate(C0091R.C0090layout.bottom_bar_layout, this));
        this.shutterButton = (ShutterButton) a.mo7919a(C0091R.C0089id.shutter_button);
        this.photoSwitchButton = (SmoothRotateSwitchButton) a.mo7919a(C0091R.C0089id.photo_switch_button);
        ...
        this.videoSwitchButton = (SmoothRotateSwitchButton) a.mo7919a(C0091R.C0089id.video_switch_button);
        this.videoSwitchButton.setIsPhotoButton(false);
        this.videoSwitchButton.setEnabled(false);
        this.pauseResumeButton = (PauseResumeButton) a.mo7919a(C0091R.C0089id.pause_resume_button);
        this.cameraSwitchButton = (CameraSwitchButton) a.mo7919a(C0091R.C0089id.camera_switch_button);
        this.snapshotButton = (SnapshotButton) a.mo7919a(C0091R.C0089id.snapshot_button);
        this.thumbnailView = (RoundedThumbnailView) a.mo7919a(C0091R.C0089id.thumbnail_button);
        this.hfrButton = (HfrButton) a.mo7919a(C0091R.C0089id.hfr_button);
        this.cancelButton = (ImageButton) a.mo7919a(C0091R.C0089id.cancel_button);
        this.retakeButton = (ImageButton) a.mo7919a(C0091R.C0089id.retake_button);
        this.reviewPlayButton = (ImageButton) a.mo7919a(C0091R.C0089id.review_play_button);
    }
    ...
    protected void onFinishInflate() {
        ...
        this.verticalOffset = getResources().getDimensionPixelSize(C0091R.dimen.bottom_bar_vertical_offset);
        this.contentSidePadding = getResources().getDimensionPixelSize(C0091R.dimen.bottom_bar_side_padding);
