        ...
        if (hashMap != null) {
            for (Entry entry : hashMap.entrySet()) {
                ...
                if (filter.getConnectedInputPort(str) == null && portInfo.isRequired()) {
                    ...
                    stringBuilder = new StringBuilder((String.valueOf(valueOf).length() + 45) + String.valueOf(str).length());
        ...
        if (hashMap != null) {
            for (Entry entry : hashMap.entrySet()) {
                ...
                if (filter.getConnectedOutputPort(str) == null && portInfo.isRequired()) {
                    valueOf = String.valueOf(filter);
                    stringBuilder = new StringBuilder((String.valueOf(valueOf).length() + 46) + String.valueOf(str).length());
                    stringBuilder.append("Filter ");
                    stringBuilder.append(valueOf);
