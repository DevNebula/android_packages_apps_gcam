...
public final class GraphRunner {
    ...
    class FilterTiming {
        ...
        /* synthetic */ FilterTiming(C01161 c01161) {
            this();
        }
    }
    ...
    final class GraphRunLoop implements Runnable {
        ...
        class C01181 implements Comparator {
            C01181(GraphRunLoop graphRunLoop) {
            }
        ...
        private final void dumpTimings(long j, long j2) {
            ...
            Comparator c01181 = new C01181(this);
            Collections.sort(arrayList, c01181);
            Collections.sort(arrayList2, c01181);
            timingLog("\n*** Timings ***\n");
    ...
    class RunParameters {
        ...
        /* synthetic */ RunParameters(C01161 c01161) {
            this();
        }
    }
    ...
    class ScheduleResult {
        ...
        /* synthetic */ ScheduleResult(C01161 c01161) {
            this();
        }
    }
    ...
    class FilterPriorityScheduler implements Scheduler {
        ...
        class C01171 implements Comparator {
            C01171(FilterPriorityScheduler filterPriorityScheduler) {
            }
        ...
        private FilterPriorityScheduler() {
            ...
            this.mFilterComparator = new C01171(this);
        }

        /* synthetic */ FilterPriorityScheduler(C01161 c01161) {
            this();
        }
        ...
        public void nextFilter(Filter[] filterArr, ScheduleResult scheduleResult) {
            ...
            while (true) {
                ...
                if (filter2.isSleeping()) {
                    access$1300 = (long) GraphRunner.PRIORITY_SLEEP;
    ...
    class LruScheduler implements Scheduler {
        ...
        /* synthetic */ LruScheduler(C01161 c01161) {
            this();
        }
    ...
    abstract class ScoringScheduler implements Scheduler {
        ...
        /* synthetic */ ScoringScheduler(GraphRunner graphRunner, C01161 c01161) {
            this(graphRunner);
        }
    ...
    class LfuScheduler extends ScoringScheduler {
        ...
        private LfuScheduler(GraphRunner graphRunner) {
            super(graphRunner, null);
        }

        /* synthetic */ LfuScheduler(GraphRunner graphRunner, C01161 c01161) {
            this(graphRunner);
        }
    ...
    class OneShotScheduler extends LfuScheduler {
        ...
        /* synthetic */ OneShotScheduler(GraphRunner graphRunner, C01161 c01161) {
            this(graphRunner);
        }
    ...
    private final void createScheduler(int i) {
        switch (i) {
            case 2:
                ...
                return;
            case 3:
                this.mScheduler = new LfuScheduler(this, null);
                return;
            case 4:
                this.mScheduler = new OneShotScheduler(this, null);
                return;
            case 5:
