...
public class SurfaceFrameDistributor {
    ...
    class C01252 implements OnFrameAvailableListener {
        ...
        public void onFrameAvailable(SurfaceTexture surfaceTexture) {
            SurfaceFrameDistributor.this.mHandler.post(new C01241());
        }
    }
    ...
    class C01306 implements OnFrameAvailableListener {
        ...
        public void onFrameAvailable(SurfaceTexture surfaceTexture) {
            SurfaceFrameDistributor.this.mHandler.post(new C01291());
        }
    }
    ...
    public SurfaceFrameDistributor(Listener listener, final SurfaceTexture surfaceTexture, Handler handler) {
        this(listener, new SurfaceTextureManager() {
        ...
        setOnFrameAvailableListener(surfaceTexture, new C01252(), handler);
    }
    ...
    public SurfaceFrameDistributor(Listener listener, SurfaceTextureManager surfaceTextureManager, Handler handler) {
        ...
        this.mFrameListener = new C01306();
