...
public class MediaDecoder implements AudioFrameProvider, VideoStreamProvider {
    ...
    class AtomicCounter {
        ...
        /* synthetic */ AtomicCounter(C06591 c06591) {
            this();
        }
    ...
    class DecoderRunnable implements Runnable {
        ...
        /* synthetic */ DecoderRunnable(MediaDecoder mediaDecoder, C06591 c06591) {
            this();
        }
    ...
    class C06591 implements Listener {
    ...
    public MediaDecoder(Context context, Uri uri, long j, long j2, boolean z) {
        ...
        this.mTrackListener = new C06591();
        if (context == null) {
        ...
        if (j < 0) {
            ...
            this.mDecoderLoop = new DecoderRunnable(this, null);
