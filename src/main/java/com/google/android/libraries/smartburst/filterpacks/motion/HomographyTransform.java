...
public final class HomographyTransform {
    ...
    private HomographyTransform(float[] fArr) {
        ...
        jri.m13396a(z, (Object) "Transform length must be of length 9");
    ...
    public final float getValue(int i) {
        ...
        jri.m13396a(z, (Object) "Exceeds transform dimensions.");
    ...
    public final float getValue(int i, int i2) {
        ...
        jri.m13396a(z, (Object) "Exceeds row limit.");
        if (i2 >= 3) {
            z2 = false;
        }
        jri.m13396a(z2, (Object) "Exceeds column limit.");
