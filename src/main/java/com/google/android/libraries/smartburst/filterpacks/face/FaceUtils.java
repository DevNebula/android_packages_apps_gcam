...
public class FaceUtils {
    ...
    public static float getAverageFaceImageDistance(List list, List list2, List list3, List list4, int i, int i2) {
        ...
        jri.m13404b((Object) list2);
        jri.m13404b((Object) list3);
        jri.m13404b((Object) list4);
    ...
    private static jzp getFaceDimension(int i, int i2, Face face) {
        ...
        return jzp.m4772a(computeCropDimensions[0], computeCropDimensions[1]);
    }
    ...
    public static float getFaceImageDistance(ByteBuffer byteBuffer, jzp jzp, ByteBuffer byteBuffer2, jzp jzp2) {
        ...
        jri.m13404b((Object) byteBuffer2);
        jri.m13404b((Object) jzp);
        jri.m13404b((Object) jzp2);
        int i = jzp.f8515a;
        if (i > 0) {
            int i2 = jzp.f8516b;
            if (i2 > 0) {
        ...
        Log.e(TAG, String.format("Face dimensions must be positive. Current dimensions are (%d, %d) and (%d %d).", new Object[]{Integer.valueOf(i), Integer.valueOf(jzp.f8516b), Integer.valueOf(jzp2.f8515a), Integer.valueOf(jzp2.f8516b)}));
        return Float.POSITIVE_INFINITY;
    }
    ...
    public static float getFacialExpressionScoreDistance(Face face, Face face2) {
        ...
        float f2;
        float f3 = 0.0f;
        jri.m13404b((Object) face);
        jri.m13404b((Object) face2);
