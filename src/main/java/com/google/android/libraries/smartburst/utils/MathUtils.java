...
public class MathUtils {
    ...
    /* renamed from: a */
    private static int[] m1388a(float[] fArr, boolean z) {
        int i = 1;
        int i2 = 0;
        ...
        if (b instanceof kmj) {
            kmj kmj = (kmj) b;
            return Arrays.copyOfRange(kmj.f8705a, kmj.f8706b, kmj.f8707c);
        }
        Object[] toArray = b.toArray();
        i3 = toArray.length;
        int[] iArr = new int[i3];
        while (i2 < i3) {
            iArr[i2] = ((Number) jri.m13404b(toArray[i2])).intValue();
            i2++;
        }
        return iArr;
    }
    ...
    public static int[] findLocalMaxima(float[] fArr) {
        return m1388a(fArr, true);
    }

    public static int[] findLocalMinima(float[] fArr) {
        return m1388a(fArr, false);
    }
    ...
    public static jzp fitSizeAround(jzp jzp, jzp jzp2) {
        ...
        int i6 = jzp.f8515a;
        if (i5 >= i6) {
            return jzp.m4772a(i2, i3 / i6);
        }
        return jzp.m4772a((i4 * i6) / i, i4);
    }
    ...
    /* renamed from: a */
    private static float[] m1387a(float[] fArr, int i) {
        int i2;
