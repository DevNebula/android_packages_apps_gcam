...
public class FilterGraph {
    ...
    public class Builder {
        ...
        public VariableSource assignVariableToFilterInput(String str, String str2, String str3) {
            ...
            StringBuilder stringBuilder;
            if (filter == null) {
                stringBuilder = new StringBuilder(String.valueOf(str2).length() + 18);
                stringBuilder.append("Unknown filter '");
        ...
        for (Filter filter : this.mFilters) {
            ...
            for (InputPort inputPort : filter.getConnectedInputPorts()) {
                ...
                if (sourceHint != null) {
                    ...
                    stringBuilder = new StringBuilder((String.valueOf(name2).length() + 2) + String.valueOf(name).length());
            ...
            for (OutputPort outputPort : filter.getConnectedOutputPorts()) {
                ...
                stringBuilder = new StringBuilder((((String.valueOf(name5).length() + 14) + String.valueOf(valueOf).length()) + String.valueOf(name4).length()) + String.valueOf(str).length());
                stringBuilder.append("  OUT: ");
                stringBuilder.append(name5);
                stringBuilder.append(" =[");
                stringBuilder.append(valueOf);
                stringBuilder.append("]=> ");
