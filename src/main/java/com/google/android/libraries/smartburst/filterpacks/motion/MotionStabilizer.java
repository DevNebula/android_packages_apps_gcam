...
public class MotionStabilizer {
    ...
    public final List mStabilizedTransforms = khb.m4945b();
    ...
    public static MotionStabilizer createFrom(FeatureTable featureTable, long j, long j2) {
        ...
        while (rowIterator.mo9482a()) {
            ...
            if (jky.mo9481b() >= j) {
                ...
                HomographyTransform createHomographyTransform = HomographyTransform.createHomographyTransform(featureTable.getFeature(jky.mo9481b(), jza.INTERFRAME_HOMOGRAPHY).getValues());
                if (createHomographyTransform.closeTo(homographyTransform, 1.0E-7f)) {
                    ...
                    motionStabilizer.addInterframeTransform(createHomographyTransform, jky.mo9481b());
                    homographyTransform = createHomographyTransform;
                }
            }
        }
