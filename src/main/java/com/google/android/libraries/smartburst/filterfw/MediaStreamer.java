...
public class MediaStreamer implements VideoStreamProvider {
    ...
    class C01191 implements OnCompletionListener {
        C01191() {
        }
    ...
    class C01202 implements OnVideoSizeChangedListener {
        C01202() {
        }
    ...
    class C06553 implements SurfaceTextureManager {
    ...
    public MediaStreamer(Context context, Uri uri) {
        ...
        this.mSurfaceTextureManager = new C06553();
        this.mMediaPlayer = MediaPlayer.create(context, uri);
        this.mMediaPlayer.setOnCompletionListener(new C01191());
        this.mMediaPlayer.setOnVideoSizeChangedListener(new C01202());
