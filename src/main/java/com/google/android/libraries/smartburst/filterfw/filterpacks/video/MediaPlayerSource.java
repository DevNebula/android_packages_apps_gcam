...
public class MediaPlayerSource extends Filter {
    ...
    public int mWidth;
    public OnCompletionListener onCompletionListener = new C01473();
    public OnFrameAvailableListener onMediaFrameAvailableListener = new C01484();
    public OnPreparedListener onPreparedListener = new C01451();
    public OnVideoSizeChangedListener onVideoSizeChangedListener = new C01462();

    /* compiled from: PG */
    /* renamed from: com.google.android.libraries.smartburst.filterfw.filterpacks.video.MediaPlayerSource$1 */
    class C01451 implements OnPreparedListener {
        C01451() {
        }
    ...
    class C01462 implements OnVideoSizeChangedListener {
        C01462() {
        }
    ...
    class C01473 implements OnCompletionListener {
        C01473() {
        }
