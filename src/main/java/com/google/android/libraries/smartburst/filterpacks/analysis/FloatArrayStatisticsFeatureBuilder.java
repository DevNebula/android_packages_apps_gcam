...
public class FloatArrayStatisticsFeatureBuilder extends Filter {
    ...
    protected void onProcess() {
        ...
        if (jza2 == null) {
            jza2 = jza.m4766a((String) asFrameValue.getValue());
        ...
        asFrameValue2.setValue(new Feature(jza, new float[]{(float) a.f8518a, (float) a.f8519b, (float) a.f8520c, (float) a.f8521d}));
