...
public class FaceEditor {
    ...
    public class Builder {
        ...
        public FaceEditor build() {
            ...
            jri.m13406b(z, (Object) "Width must be positive.");
            if (this.mHeight <= 0) {
                z2 = false;
            }
            jri.m13406b(z2, (Object) "Height must be positive.");
        ...
        public Builder setFrameDimensions(int i, int i2) {
            ...
            jri.m13396a(z, (Object) "Width must be positive");
            if (i2 <= 0) {
                z2 = false;
            }
            jri.m13396a(z2, (Object) "Height must be positive");
            this.mWidth = i;
            this.mHeight = i2;
            return this;
        }
    ...
    public synchronized void addPhoto(jqr jqr, List list, long j) {
        ...
        try {
            ...
            Buffer allocateDirect = ByteBuffer.allocateDirect(((Bitmap) jqr.mo9674e()).getByteCount());
            ((Bitmap) jqr.mo9674e()).copyPixelsToBuffer(allocateDirect);
            if (list.isEmpty()) {
                if (this.mConfiguredForPittPatt) {
                ...
                while (true) {
                    ...
                    f2 = FaceUtils.getJoyScore(faceData.isLeftEyeOpenScore, faceData.isRightEyeOpenScore, faceData.isSmilingScore, 0.25f, 0.25f, 0.5f) + f;
                }
    ...
    public synchronized jqr createAllSmiles(jqo jqo, boolean z) {
        jqr jqr;
        boolean z2;
        jri.m13406b(this.mConfiguredForAnimation ^ 1, (Object) "Editor is configured for animation. Cannot create all-smiles.");
        ...
        jri.m13404b(this.mBestInputBitmap);
        try {
            ...
            if (faceEditingCreateAllSmiles == null) {
                ...
                jqr = jqp.m4669a(jqo, "all-smiles", ByteBuffer.wrap(faceEditingCreateAllSmiles), this.mWidth, this.mHeight);
                closeInputBitmap();
            }
        } finally {
            closeInputBitmap();
    ...
    public synchronized List createAnimation(jqo jqo, boolean z, int i) {
        ...
        synchronized (this) {
            boolean z3;
            jri.m13406b(this.mConfiguredForAnimation, (Object) "Editor is configured for all-smiles. Cannot create animation.");
            if (this.mIndexTimestampMap.size() > 0) {
                z3 = true;
            } else {
                z3 = false;
            ...
            try {
                ...
                if (faceEditingCreateAnimation == null) {
                    ...
                    for (int i3 = 0; i3 < length; i3++) {
                        ...
                        arrayList.add(jqp.m4669a(jqo, stringBuilder.toString(), allocateDirect, this.mWidth, this.mHeight));
                    }
                }
    ...
    public static List getCroppedFaceData(List list, List list2, float f) {
        ...
        while (true) {
            ...
            arrayList.add(new FaceData((Rect) pair.first, (Rect) pair.second, (Face) list.get(i2), f));
            i = i2 + 1;
        }
    }
    ...
    public static List getUncroppedFaceData(List list, float f) {
        ...
        while (true) {
            ...
            arrayList.add(new FaceData((Face) list.get(i2), f));
            i = i2 + 1;
        }
    }
}
