...
public class GpuVideoTrackDecoder extends VideoTrackDecoder {
    ...
    class C06571 implements Listener {
        C06571() {
        }
    ...
    class C06582 implements SurfaceTextureManager {
    ...
    public GpuVideoTrackDecoder(int i, MediaFormat mediaFormat, Listener listener) {
        ...
        this.mDistributor = new SurfaceFrameDistributor(new C06571(), new C06582(), new Handler(this.mFrameServerThread.getLooper()));
