...
public final class ModelManager {
    ...
    public Handler mHandler = new Handler(new ModelManagerHandlerCallback(this, null));
    ...
    class ModelManagerHandlerCallback implements Callback {
        ...
        /* synthetic */ ModelManagerHandlerCallback(ModelManager modelManager, C01531 c01531) {
            this();
        }
    ...
    final void downloadAndInstallModels(ModelManagerCallbacks modelManagerCallbacks) {
        ...
        if ("mounted_ro".equals(externalStorageState)) {
            ...
            File file2 = new File(this.mDataDirectoryName);
            if (file2.exists() || file2.mkdirs()) {
                ...
                StringBuilder stringBuilder2 = new StringBuilder((String.valueOf(file).length() + 1) + String.valueOf(externalStorageState).length());
                ...
                externalStorageState = String.valueOf(file);
                String str2 = "file://";
                        ...
                        if ("android.intent.action.DOWNLOAD_COMPLETE".equals(intent.getAction())) {
                            ...
                            if (query2.moveToFirst()) {
                                ...
                                if (i2 == 8) {
                                    ...
                                    stringBuilder.append("Download failed, error code = ");
                                    stringBuilder.append(i2);
                                    Log.e(ModelManager.TAG, stringBuilder.toString());
                                    str = string;
                                    i = 1;
                                } else {
                                    stringBuilder = new StringBuilder(37);
                                    stringBuilder.append("Download failed, status = ");
                                    stringBuilder.append(i2);
                                    Log.e(ModelManager.TAG, stringBuilder.toString());
                                    str = string;
                                    i = 1;
            ...
            file = "Could not create directory: ";
            if (externalStorageState.length() == 0) {
                externalStorageState = new String(file);
            } else {
                externalStorageState = file.concat(externalStorageState);
            }
            ...
            file = "Cannot access storage, state = ";
            if (externalStorageState.length() == 0) {
                externalStorageState = new String(file);
            } else {
                externalStorageState = file.concat(externalStorageState);
