...
public final class eventprotos$BackgroundEvent extends kvf {
    ...
    public final eventprotos$BackgroundEvent clear() {
        ...
        this.previewSmoothnessReport = klq.m16949a();
        this.dirtyLensEvents = kjz.m16920a();
        this.shutterButtonDisabledDuration = 0.0f;
        this.meteringData = klf.m16937a();
    ...
    protected final int computeSerializedSize() {
        ...
        if (kvl2 != null) {
            computeSerializedSize += kvd.m5479a(1, kvl2);
        }
        ...
        if (klfArr != null && klfArr.length > 0) {
            while (true) {
                ...
                kvl2 = klfArr[i2];
                if (kvl2 != null) {
                    computeSerializedSize += kvd.m5479a(6, kvl2);
                }
                i2++;
            }
        }
        ...
        while (true) {
            ...
            switch (i) {
                ...
                case 34:
                    ...
                    continue;
                case 45:
                    this.shutterButtonDisabledDuration = Float.intBitsToFloat(kvc.mo10481d());
                    continue;
                case 50:
                    a = kvn.m5518a(kvc, 50);
    ...
    public final void writeTo(kvd kvd) {
        ...
        if (Float.floatToIntBits(this.shutterButtonDisabledDuration) != Float.floatToIntBits(0.0f)) {
            kvd.mo10490a(5, this.shutterButtonDisabledDuration);
        }
        klf[] klfArr = this.meteringData;
        if (klfArr != null && klfArr.length > 0) {
            while (true) {
