...
public final class eventprotos$CaptureTiming extends kvf {
    ...
    public final eventprotos$CaptureTiming clear() {
        ...
        this.captureScoreCalculations = klb.m16935a();
    ...
    protected final int computeSerializedSize() {
        ...
        if (j != 0) {
            computeSerializedSize += kvd.m5477a(10, j);
        }
        ...
        if (j != 0) {
            computeSerializedSize += kvd.m5477a(12, j);
        }
        j = this.capturePersistedStartNs;
        if (j != 0) {
            computeSerializedSize += kvd.m5477a(13, j);
        }
        ...
        while (true) {
            ...
            switch (i) {
                case 0:
                    break;
                case 8:
                    this.captureStartNs = kvc.mo10486g();
                    continue;
                case 16:
                    this.captureTinyThumbNs = kvc.mo10486g();
                    continue;
                case 24:
                    this.captureMediumThumbNs = kvc.mo10486g();
                    continue;
                case 32:
                    this.captureProcessingStartNs = kvc.mo10486g();
                    continue;
                case 40:
                    this.captureProcessingEndNs = kvc.mo10486g();
                    continue;
                case 48:
                    this.capturePersistedEndNs = kvc.mo10486g();
                    continue;
                case 56:
                    this.captureRequestSubmittedNs = kvc.mo10486g();
                    continue;
                case 64:
                    this.captureRequestReceivedNs = kvc.mo10486g();
                    continue;
                case 72:
                    this.captureFrameSelectStartNs = kvc.mo10486g();
                    continue;
                case 80:
                    this.captureFrameSelectEndNs = kvc.mo10486g();
                    continue;
                case 88:
                    this.captureMergeStartNs = kvc.mo10486g();
                    continue;
                case 96:
                    this.captureMergeEndNs = kvc.mo10486g();
                    continue;
                case 104:
                    this.capturePersistedStartNs = kvc.mo10486g();
                    continue;
                case 114:
                    int a = kvn.m5518a(kvc, 114);
