...
public class ImageSaver {
    ...
    public String Save(C0158x12336837 c0158x12336837, String str) {
        return GcamModuleJNI.ImageSaver_Save__SWIG_2(this.swigCPtr, this, C0158x12336837.getCPtr(c0158x12336837), str);
    }
