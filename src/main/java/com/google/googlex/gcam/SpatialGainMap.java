...
public class SpatialGainMap {
    ...
    public SpatialGainMap(C0157x20324196 c0157x20324196, boolean z, boolean z2) {
        this(GcamModuleJNI.new_SpatialGainMap__SWIG_4(C0157x20324196.getCPtr(c0157x20324196), z, z2), true);
    }

    public SpatialGainMap(C0157x20324196 c0157x20324196, boolean z, boolean z2, SWIGTYPE_p_gcam__TImageSampleAllocator sWIGTYPE_p_gcam__TImageSampleAllocator) {
        this(GcamModuleJNI.new_SpatialGainMap__SWIG_3(C0157x20324196.getCPtr(c0157x20324196), z, z2, SWIGTYPE_p_gcam__TImageSampleAllocator.getCPtr(sWIGTYPE_p_gcam__TImageSampleAllocator)), true);
    }
