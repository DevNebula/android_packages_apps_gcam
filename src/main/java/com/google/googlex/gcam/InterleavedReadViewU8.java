...
public class InterleavedReadViewU8 {
    ...
    /* renamed from: at */
    public short mo4494at(int i, int i2, int i3) {
    ...
    public C0160x2169a37f sample_iterator() {
        return new C0160x2169a37f(GcamModuleJNI.InterleavedReadViewU8_sample_iterator__SWIG_0(this.swigCPtr, this), true);
    }

    public C0160x2169a37f sample_iterator(int i) {
        return new C0160x2169a37f(GcamModuleJNI.InterleavedReadViewU8_sample_iterator__SWIG_1(this.swigCPtr, this, i), true);
    }
