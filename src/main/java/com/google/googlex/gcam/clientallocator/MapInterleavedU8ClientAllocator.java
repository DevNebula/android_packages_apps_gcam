...
public class MapInterleavedU8ClientAllocator extends ClientInterleavedU8Allocator {
    ...
    public void Release(long j) {
        jri.m13405b(this.allocatedImages.containsKey(Long.valueOf(j)));
    }

    public kbg findImageFromView(InterleavedReadViewU8 interleavedReadViewU8) {
        return kbg.m4803b((InterleavedImageU8) this.allocatedImages.get(Long.valueOf(getBaseAddress(interleavedReadViewU8))));
    }
