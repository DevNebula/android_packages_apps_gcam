...
public class UniqueBitmapClientAllocator extends ClientInterleavedU8Allocator {
    ...
    public UniqueBitmapClientAllocator(DisplayMetrics displayMetrics, long j) {
        boolean z;
        this.allocatedBitmap = kau.f21835a;
    ...
    public InterleavedU8Allocation Allocate(int i, int i2, int i3) {
        ...
        jri.m13398a(z, "Server requested an InterleavedImageU8 of %s channels, but UniqueBitmapClientAllocator only supports %s.", i3, 4);
        jri.m13406b(this.allocatedBitmap.mo9709b() ^ 1, (Object) "Allocate() should be called at most once.");
        ...
        this.allocatedBitmap = kbg.m4804c(createBitmap);
    ...
    public void Release(long j) {
        ...
        jri.m13395a(z);
        jri.m13406b(this.allocatedBitmap.mo9709b(), (Object) "Release() was called before Allocate().");
        if (this.lock == null) {
            z2 = false;
        }
        jri.m13406b(z2, (Object) "Release() was called more than once.");
        this.lock.close();
        this.lock = null;
    }
