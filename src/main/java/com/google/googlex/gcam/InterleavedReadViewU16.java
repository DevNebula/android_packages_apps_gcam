...
public class InterleavedReadViewU16 {
    ...
    /* renamed from: at */
    public int mo4475at(int i, int i2, int i3) {
    ...
    public C0162x2c938a65 sample_iterator() {
        return new C0162x2c938a65(GcamModuleJNI.InterleavedReadViewU16_sample_iterator__SWIG_0(this.swigCPtr, this), true);
    }

    public C0162x2c938a65 sample_iterator(int i) {
        return new C0162x2c938a65(GcamModuleJNI.InterleavedReadViewU16_sample_iterator__SWIG_1(this.swigCPtr, this, i), true);
    }
