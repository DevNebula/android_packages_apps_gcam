...
public class PackedImageRaw12 extends PackedReadWriteViewRaw12 {
    ...
    public PackedImageRaw12(C0158x12336837 c0158x12336837) {
        this(GcamModuleJNI.new_PackedImageRaw12__SWIG_5(C0158x12336837.getCPtr(c0158x12336837)), true);
    }

    public PackedImageRaw12(C0158x12336837 c0158x12336837, SWIGTYPE_p_gcam__TImageSampleAllocator sWIGTYPE_p_gcam__TImageSampleAllocator) {
        this(GcamModuleJNI.new_PackedImageRaw12__SWIG_4(C0158x12336837.getCPtr(c0158x12336837), SWIGTYPE_p_gcam__TImageSampleAllocator.getCPtr(sWIGTYPE_p_gcam__TImageSampleAllocator)), true);
    }
