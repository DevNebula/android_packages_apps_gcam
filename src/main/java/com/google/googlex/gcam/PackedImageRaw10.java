...
public class PackedImageRaw10 extends PackedReadWriteViewRaw10 {
    ...
    public PackedImageRaw10(C0158x12336837 c0158x12336837) {
        this(GcamModuleJNI.new_PackedImageRaw10__SWIG_5(C0158x12336837.getCPtr(c0158x12336837)), true);
    }

    public PackedImageRaw10(C0158x12336837 c0158x12336837, SWIGTYPE_p_gcam__TImageSampleAllocator sWIGTYPE_p_gcam__TImageSampleAllocator) {
        this(GcamModuleJNI.new_PackedImageRaw10__SWIG_4(C0158x12336837.getCPtr(c0158x12336837), SWIGTYPE_p_gcam__TImageSampleAllocator.getCPtr(sWIGTYPE_p_gcam__TImageSampleAllocator)), true);
    }
