...
public class MetadataConverter {
    ...
    public MetadataConverter(iun iun) {
        ...
        this.minIsoGain = ((Integer) ((Range) iun.mo9056a(CameraCharacteristics.SENSOR_INFO_SENSITIVITY_RANGE)).getLower()).intValue();
        int intValue = ((Integer) iun.mo9056a(CameraCharacteristics.SENSOR_INFO_COLOR_FILTER_ARRANGEMENT)).intValue();
        this.redBlueIndexMap = getRedBlueSourceIndicesForCfa(intValue);
        this.evenOddIndexMap = getEvenOddSourceIndicesForCfa(intValue);
        this.sensorActiveArraySize = (Rect) iun.mo9056a(CameraCharacteristics.SENSOR_INFO_ACTIVE_ARRAY_SIZE);
        this.faceDetectMode = iun.mo9070i().f7853d;
    }

    private void appendFaceInfo(Face[] faceArr, FaceInfoVector faceInfoVector) {
        Rect rect = (Rect) this.characteristics.mo9056a(CameraCharacteristics.SENSOR_INFO_ACTIVE_ARRAY_SIZE);
    ...
    private ColorSpaceTransform convertToColorSpaceTransform(float[] fArr) {
        ...
        jri.m13397a(z, "ccm must have length %s.", 9);
    ...
    public FrameMetadata convertToGcamFrameMetadata(iwp iwp, Face[] faceArr, GyroSampleVector gyroSampleVector) {
        ...
        int intValue = ((Integer) iwp.mo13730a(CaptureResult.FLASH_MODE)).intValue();
        ...
        Rational[] rationalArr = (Rational[]) iwp.mo13730a(CaptureResult.SENSOR_NEUTRAL_COLOR_POINT);
        ...
        frameMetadata.setTimestamp_ns(((Long) iwp.mo13730a(CaptureResult.SENSOR_TIMESTAMP)).longValue());
        ...
        Pair[] pairArr = (Pair[]) iwp.mo13730a(CaptureResult.SENSOR_NOISE_PROFILE);
        ...
        analogAndDigitalGain = (float[]) iwp.mo13730a(CaptureResult.SENSOR_DYNAMIC_BLACK_LEVEL);
        if (analogAndDigitalGain != null) {
            frameMetadata.setBlack_levels_bayer(analogAndDigitalGain);
        } else {
            BlackLevelPattern blackLevelPattern = (BlackLevelPattern) this.characteristics.mo9056a(CameraCharacteristics.SENSOR_BLACK_LEVEL_PATTERN);
            fArr = new float[4];
        ...
        Float f = (Float) iwp.mo13730a(CaptureResult.LENS_FOCUS_DISTANCE);
        Integer num2 = (Integer) this.characteristics.mo9056a(CameraCharacteristics.LENS_INFO_FOCUS_DISTANCE_CALIBRATION);
        if (!(f == null || num2 == null || (num2.intValue() != 2 && num2.intValue() != 1))) {
            frameMetadata.setFocus_distance_diopters(f.floatValue());
        }
        f = (Float) iwp.mo13730a(CaptureResult.LENS_FOCAL_LENGTH);
        if (f != null) {
            frameMetadata.setFocal_length_mm(f.floatValue());
        }
        frameMetadata.setControl_mode(((Integer) iwp.mo13730a(CaptureResult.CONTROL_MODE)).intValue());
        AeMetadata aeMetadata = new AeMetadata();
        aeMetadata.setMode(((Integer) iwp.mo13730a(CaptureResult.CONTROL_AE_MODE)).intValue());
        aeMetadata.setLock(((Boolean) iwp.mo13730a(CaptureResult.CONTROL_AE_LOCK)).booleanValue());
        aeMetadata.setState(((Integer) iwp.mo13730a(CaptureResult.CONTROL_AE_STATE)).intValue());
        num = (Integer) iwp.mo13730a(CaptureResult.CONTROL_AE_PRECAPTURE_TRIGGER);
        if (num != null) {
            aeMetadata.setPrecapture_trigger(num.intValue());
        }
        aeMetadata.setExposure_compensation(getExposureCompensationStops(((Integer) iwp.mo13730a(CaptureResult.CONTROL_AE_EXPOSURE_COMPENSATION)).intValue()));
        appendMeteringRectanglesAsGcamWeightedPixelRects((MeteringRectangle[]) iwp.mo13730a(CaptureResult.CONTROL_AE_REGIONS), aeMetadata.getMetering_rectangles());
        frameMetadata.setAe(aeMetadata);
        AwbMetadata awbMetadata = new AwbMetadata();
        awbMetadata.setMode(((Integer) iwp.mo13730a(CaptureResult.CONTROL_AWB_MODE)).intValue());
        awbMetadata.setLock(((Boolean) iwp.mo13730a(CaptureResult.CONTROL_AWB_LOCK)).booleanValue());
        awbMetadata.setState(((Integer) iwp.mo13730a(CaptureResult.CONTROL_AWB_STATE)).intValue());
        appendMeteringRectanglesAsGcamWeightedPixelRects((MeteringRectangle[]) iwp.mo13730a(CaptureResult.CONTROL_AWB_REGIONS), awbMetadata.getMetering_rectangles());
        frameMetadata.setAwb(awbMetadata);
        AfMetadata afMetadata = new AfMetadata();
        afMetadata.setMode(((Integer) iwp.mo13730a(CaptureResult.CONTROL_AF_MODE)).intValue());
        afMetadata.setState(((Integer) iwp.mo13730a(CaptureResult.CONTROL_AF_STATE)).intValue());
        afMetadata.setTrigger(((Integer) iwp.mo13730a(CaptureResult.CONTROL_AF_TRIGGER)).intValue());
        appendMeteringRectanglesAsGcamWeightedPixelRects((MeteringRectangle[]) iwp.mo13730a(CaptureResult.CONTROL_AF_REGIONS), afMetadata.getMetering_rectangles());
        ...
        if (!(hsz.f6980h == null || hsz.f6981i == null)) {
            oisMetadata.setTimestamp_ois_clock_ns(((Long) iwp.mo13730a(hsz.f6980h)).longValue());
            ...
            if (ExperimentalKeys.getLibraryVersion() >= 3 && hsz.f6984l != null && hsz.f6985m != null) {
                fArr = (float[]) iwp.mo13730a(hsz.f6984l);
                analogAndDigitalGain = (float[]) iwp.mo13730a(hsz.f6985m);
                length = jArr.length;
                length2 = fArr.length;
                if (length == length2) {
                    z2 = true;
                ...
                jri.m13396a(z2, stringBuilder.toString());
        ...
        if (hsz.f6986n != null) {
            frameMetadata.setExposure_time_boost(((Float) iwp.mo13730a(hsz.f6986n)).floatValue());
        }
    ...
    public static StaticMetadata convertToGcamStaticMetadata(iun iun) {
        ...
        staticMetadata.setHas_flash(iun.mo9082u());
        List<Float> a = iun.mo9058a();
        jri.m13396a(a.isEmpty() ^ 1, (Object) "Cameras must have at least one focal length.");
        ...
        jri.m13396a(z, (Object) "Cameras must have at least one f-number (aperture size).");
        FloatVector floatVector2 = new FloatVector();
        for (float add : (float[]) iun.mo9056a(CameraCharacteristics.LENS_INFO_AVAILABLE_APERTURES)) {
            floatVector2.add(add);
        }
        staticMetadata.setAvailable_f_numbers(floatVector2);
        BlackLevelPattern blackLevelPattern = (BlackLevelPattern) iun.mo9056a(CameraCharacteristics.SENSOR_BLACK_LEVEL_PATTERN);
        if (blackLevelPattern != null) {
            z = true;
        } else {
            z = false;
        }
        jri.m13396a(z, (Object) "SENSOR_BLACK_LEVEL_PATTERN is required.");
        float[] fArr = new float[4];
        for (i = 0; i < 4; i++) {
            fArr[i] = (float) blackLevelPattern.getOffsetForIndex(i % 2, i / 2);
        }
        staticMetadata.setBlack_levels_bayer(fArr);
        staticMetadata.setWhite_level(((Integer) iun.mo9056a(CameraCharacteristics.SENSOR_INFO_WHITE_LEVEL)).intValue());
        Rect[] rectArr = (Rect[]) iun.mo9056a(CameraCharacteristics.SENSOR_OPTICAL_BLACK_REGIONS);
        if (rectArr != null) {
        ...
        staticMetadata.setBayer_pattern(convertToBayerPattern(((Integer) iun.mo9056a(CameraCharacteristics.SENSOR_INFO_COLOR_FILTER_ARRANGEMENT)).intValue()));
        int[] iArr = new int[]{((Integer) ((Range) iun.mo9056a(CameraCharacteristics.SENSOR_INFO_SENSITIVITY_RANGE)).getLower()).intValue(), ((Integer) ((Range) iun.mo9056a(CameraCharacteristics.SENSOR_INFO_SENSITIVITY_RANGE)).getUpper()).intValue()};
        int intValue2 = ((Integer) iun.mo9056a(CameraCharacteristics.SENSOR_MAX_ANALOG_SENSITIVITY)).intValue();
        ...
        Integer num = (Integer) iun.mo9056a(CameraCharacteristics.SENSOR_REFERENCE_ILLUMINANT1);
        if (num != null) {
            convertToFloatArray = convertToFloatArray((ColorSpaceTransform) iun.mo9056a(CameraCharacteristics.SENSOR_COLOR_TRANSFORM1));
            convertToFloatArray2 = convertToFloatArray((ColorSpaceTransform) iun.mo9056a(CameraCharacteristics.SENSOR_CALIBRATION_TRANSFORM1));
        ...
        Byte b = (Byte) iun.mo9056a(CameraCharacteristics.SENSOR_REFERENCE_ILLUMINANT2);
        if (b != null) {
            convertToFloatArray = convertToFloatArray((ColorSpaceTransform) iun.mo9056a(CameraCharacteristics.SENSOR_COLOR_TRANSFORM2));
            convertToFloatArray2 = convertToFloatArray((ColorSpaceTransform) iun.mo9056a(CameraCharacteristics.SENSOR_CALIBRATION_TRANSFORM2));
            dngColorCalibration = new DngColorCalibration();
        ...
        if (hsz.f6994v != null) {
            intValue = ((Integer) iun.mo9056a(ExperimentalKeys.NEXUS_EXPERIMENTAL_2017_EEPROM_WB_CALIB_NUM_LIGHTS)).intValue();
            Log.v(TAG, String.format("EEPROM_WB_CALIB is available, found %d illuminants", new Object[]{Integer.valueOf(intValue)}));
            if (intValue > 0) {
                float[] fArr2 = (float[]) iun.mo9056a(ExperimentalKeys.NEXUS_EXPERIMENTAL_2017_EEPROM_WB_CALIB_R_OVER_G_RATIOS);
                convertToFloatArray2 = (float[]) iun.mo9056a(ExperimentalKeys.NEXUS_EXPERIMENTAL_2017_EEPROM_WB_CALIB_B_OVER_G_RATIOS);
        ...
        if (hsz.f6997y != null) {
            qcColorCalibration.setGrgb_ratio(((Float) iun.mo9056a(hsz.f6997y)).floatValue());
        } else {
        ...
        Size size = (Size) iun.mo9061b(CameraCharacteristics.SENSOR_INFO_PIXEL_ARRAY_SIZE);
        staticMetadata.setPixel_array_width(size.getWidth());
        staticMetadata.setPixel_array_height(size.getHeight());
        Rect rect2 = (Rect) iun.mo9061b(CameraCharacteristics.SENSOR_INFO_ACTIVE_ARRAY_SIZE);
        ...
        staticMetadata.setFrame_raw_max_width(gcamRawFormat.f7861b.f7695a);
        staticMetadata.setFrame_raw_max_height(gcamRawFormat.f7861b.f7696b);
        staticMetadata.setRaw_bits_per_pixel(ImageFormat.getBitsPerPixel(gcamRawFormat.f7860a));
        staticMetadata.setFrame_readout_time_ms(nsToMsFloat(iun.mo9055a(gcamRawFormat.f7860a, gcamRawFormat.f7861b)));
    ...
    public SpatialGainMap convertToSpatialGainMap(iwp iwp) {
        ...
        int[] evenOddSourceIndicesForCfa = getEvenOddSourceIndicesForCfa(((Integer) this.characteristics.mo9056a(CameraCharacteristics.SENSOR_INFO_COLOR_FILTER_ARRANGEMENT)).intValue());
        for (int i = 0; i < 4; i++) {
    ...
    public float[] getAnalogAndDigitalGain(iwp iwp) {
        float max;
        float f;
        int intValue = ((Integer) ((Range) this.characteristics.mo9056a(CameraCharacteristics.SENSOR_INFO_SENSITIVITY_RANGE)).getLower()).intValue();
        int intValue2 = ((Integer) this.characteristics.mo9056a(CameraCharacteristics.SENSOR_MAX_ANALOG_SENSITIVITY)).intValue();
        int intValue3 = ((Integer) iwp.mo13730a(CaptureResult.SENSOR_SENSITIVITY)).intValue();
    ...
    private float[] getAwbGains(iwp iwp) {
        boolean z;
        int i = 0;
        RggbChannelVector rggbChannelVector = (RggbChannelVector) iwp.mo13730a(CaptureResult.COLOR_CORRECTION_GAINS);
        if (rggbChannelVector != null) {
            z = true;
        } else {
            z = false;
        }
        jri.m13396a(z, (Object) "CaptureResult missing CaptureResult.COLOR_CORRECTION_GAINS.");
        float[] fArr = new float[4];
        while (i < 4) {
    ...
    private static float[] getAwbRgb2Rgb(iwp iwp) {
        ...
        jri.m13396a(z, (Object) "CaptureResult missing CaptureResult.COLOR_CORRECTION_TRANSFORM.");
    ...
    public float getExposureCompensationStops(int i) {
        Rational rational = (Rational) this.characteristics.mo9056a(CameraCharacteristics.CONTROL_AE_COMPENSATION_STEP);
    ...
    public static float getExposureTimeMs(iwp iwp) {
        return nsToMsFloat(((Long) iwp.mo13730a(CaptureResult.SENSOR_EXPOSURE_TIME)).longValue());
    }

    public static ive getGcamRawFormat(iun iun) {
        List b = iun.mo9063b(37);
        List b2 = iun.mo9063b(38);
        List b3 = iun.mo9063b(32);
        if (!b.isEmpty()) {
    ...
    public static int getGcamSensorId(iun iun) {
        Object obj = (Integer) iun.mo9056a(CameraCharacteristics.LENS_FACING);
        jri.m13404b(obj);
    ...
    public float getTotalExposureTime(iwp iwp) {
        return (((float) ((Integer) iwp.mo13730a(CaptureResult.SENSOR_SENSITIVITY)).intValue()) / ((float) ((Integer) ((Range) this.characteristics.mo9056a(CameraCharacteristics.SENSOR_INFO_SENSITIVITY_RANGE)).getLower()).intValue())) * nsToMsFloat(((Long) iwp.mo13730a(CaptureResult.SENSOR_EXPOSURE_TIME)).longValue());
    }
