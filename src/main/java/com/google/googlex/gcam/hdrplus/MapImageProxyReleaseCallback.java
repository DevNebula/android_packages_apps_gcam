...
public class MapImageProxyReleaseCallback extends ImageReleaseCallback {
    ...
    public void Run(long j) {
        ...
        jri.m13399a(z, "imageId was INVALID_IMAGE_ID (%s).", INVALID_IMAGE_ID);
        synchronized (this.lock) {
            iwz iwz = (iwz) this.imageMap.get(j);
            String str = "MapImageProxyReleaseCallback does not contain the key %s.";
            if (iwz == null) {
                throw new IllegalStateException(jri.m13393a(str, Long.valueOf(j)));
            }
            iwz.close();
    ...
    public long put(iwz iwz) {
        ...
        synchronized (this.lock) {
            ...
            jri.m13406b(z, (Object) "image has already been put in MapImageProxyReleaseCallback.");
