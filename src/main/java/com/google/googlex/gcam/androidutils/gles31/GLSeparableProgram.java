...
public class GLSeparableProgram implements Closeable {
    ...
    public GLSeparableProgram(int i, String[] strArr) {
        ...
        this.f2686id = glCreateProgram;
    }

    public void close() {
        GLES31.glDeleteProgram(this.f2686id);
    }

    public int getUniformLocation(String str) {
        return GLES31.glGetUniformLocation(this.f2686id, str);
    }
    ...
    public String infoLog() {
        return GLES31.glGetProgramInfoLog(this.f2686id);
    }

    public void setUniform1f(String str, float f) {
        GLES31.glProgramUniform1f(this.f2686id, getUniformLocation(str), f);
    }

    public void setUniform1i(String str, int i) {
        GLES31.glProgramUniform1i(this.f2686id, getUniformLocation(str), i);
    }

    public void setUniform2f(String str, float f, float f2) {
        GLES31.glProgramUniform2f(this.f2686id, getUniformLocation(str), f, f2);
    }

    public void setUniform2i(String str, int i, int i2) {
        GLES31.glProgramUniform2i(this.f2686id, getUniformLocation(str), i, i2);
    }
    ...
    public void setUniform3f(String str, float f, float f2, float f3) {
        GLES31.glProgramUniform3f(this.f2686id, getUniformLocation(str), f, f2, f3);
    }

    public void setUniform3i(String str, int i, int i2, int i3) {
        GLES31.glProgramUniform3i(this.f2686id, getUniformLocation(str), i, i2, i3);
    }
    ...
    public void setUniform4f(String str, float f, float f2, float f3, float f4) {
        GLES31.glProgramUniform4f(this.f2686id, getUniformLocation(str), f, f2, f3, f4);
    }

    public void setUniform4f(String str, Vector4f vector4f) {
        GLES31.glProgramUniform4f(this.f2686id, getUniformLocation(str), vector4f.f2705x, vector4f.f2706y, vector4f.f2707z, vector4f.f2704w);
    }
    ...
    public void setUniform4fArray(String str, float[] fArr) {
        GLES31.glProgramUniform4fv(this.f2686id, getUniformLocation(str), fArr.length >> 2, fArr, 0);
    }

    public void setUniform4i(String str, int i, int i2, int i3, int i4) {
        GLES31.glProgramUniform4i(this.f2686id, getUniformLocation(str), i, i2, i3, i4);
    }
    ...
    public void setUniformBool(String str, boolean z) {
        GLES31.glProgramUniform1i(this.f2686id, getUniformLocation(str), z);
    }
    ...
    public void setUniformMatrix4fv(String str, int i, boolean z, float[] fArr, int i2) {
        ...
        GLES31.glProgramUniformMatrix4fv(this.f2686id, getUniformLocation(str), i, z, fArr, i2);
    }
}
