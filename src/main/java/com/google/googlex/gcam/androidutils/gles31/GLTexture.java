...
public class GLTexture implements Closeable {
    ...
    public final class ImageFormats {
        ...
        /* renamed from: RG */
        public static final int f2687RG = 33319;
    ...
    public final class InternalFormats {
        ...
        /* renamed from: R8 */
        public static final int f2688R8 = 33321;
    ...
    public void bind() {
        GLES31.glBindTexture(this.target, this.f2689id);
    }

    public void close() {
        GLES31.glDeleteTextures(1, new int[]{this.f2689id}, 0);
        this.f2689id = 0;
    }
