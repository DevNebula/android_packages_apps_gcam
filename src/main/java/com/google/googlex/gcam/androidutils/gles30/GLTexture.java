...
public class GLTexture implements Closeable {
    ...
    public final class ImageFormats {
        ...
        /* renamed from: RG */
        public static final int f2680RG = 33319;
    ...
    public final class InternalFormats {
        ...
        /* renamed from: R8 */
        public static final int f2681R8 = 33321;
    ...
    public void bind() {
        GLES30.glBindTexture(this.target, this.f2682id);
    }

    public void close() {
        GLES30.glDeleteTextures(1, new int[]{this.f2682id}, 0);
        this.f2682id = 0;
    }
