...
public class GLFramebufferObject implements Closeable {
    ...
    public void attachAsDraw(int i, GLTexture2D gLTexture2D) {
        GLES31.glFramebufferTexture2D(36009, 36064 + i, 3553, gLTexture2D.mo5564id(), 0);
    }

    public void attachAsRead(int i, GLTexture2D gLTexture2D) {
        GLES31.glFramebufferTexture2D(36008, 36064 + i, 3553, gLTexture2D.mo5564id(), 0);
    }

    public void bindAsDraw() {
        GLES31.glBindFramebuffer(36009, this.f2684id);
    }

    public void bindAsDrawAndRead() {
        GLES31.glBindFramebuffer(36160, this.f2684id);
    }

    public void bindAsRead() {
        GLES31.glBindFramebuffer(36008, this.f2684id);
    }
    ...
    public void close() {
        GLES31.glDeleteFramebuffers(1, new int[]{this.f2684id}, 0);
        this.f2684id = 0;
    }
