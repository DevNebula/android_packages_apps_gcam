...
public final class AndroidUtilities {
    ...
    class C01651 implements Comparator {
        C01651() {
        }

        public int compare(Vector2i vector2i, Vector2i vector2i2) {
            int i = vector2i.f2692x * vector2i.f2693y;
            int i2 = vector2i2.f2692x * vector2i2.f2693y;
            if (i < i2) {
                return -1;
            }
            if (i > i2) {
    ...
    public static Vector2i biggestSizeLEq(List list, Vector2i vector2i) {
        ...
        for (Vector2i vector2i2 : list) {
            if (vector2i2.f2692x <= vector2i.f2692x && vector2i2.f2693y <= vector2i.f2693y) {
    ...
    public static Vector2i getLargestSizeByPixelCount(List list) {
        return (Vector2i) Collections.max(list, new C01651());
    }
