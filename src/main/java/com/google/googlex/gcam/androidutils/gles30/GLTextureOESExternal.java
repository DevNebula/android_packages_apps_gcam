...
public class GLTextureOESExternal extends GLTexture {
    ...
    public GLTextureOESExternal(int i, int i2) {
        ...
        this.surfaceTexture = new SurfaceTexture(mo5500id());
