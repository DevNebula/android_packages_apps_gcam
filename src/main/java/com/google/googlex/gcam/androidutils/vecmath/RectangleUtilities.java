...
public final class RectangleUtilities {
    ...
    public static Rect2f bestFitKeepAR(Vector2f vector2f, Rect2f rect2f) {
        float min = Math.min(rect2f.width(), (rect2f.height() * vector2f.f2690x) / vector2f.f2691y);
        float min2 = Math.min((rect2f.width() * vector2f.f2691y) / vector2f.f2690x, rect2f.height());
        return new Rect2f(rect2f.origin().f2690x + ((rect2f.width() - min) * 0.5f), ((rect2f.height() - min2) * 0.5f) + rect2f.origin().f2691y, min, min2);
    }

    public static Rect2i bestFitKeepAR(Vector2i vector2i, Rect2i rect2i) {
        int min = Math.min(rect2i.width(), (rect2i.height() * vector2i.f2692x) / vector2i.f2693y);
        int min2 = Math.min((rect2i.width() * vector2i.f2693y) / vector2i.f2692x, rect2i.height());
        return new Rect2i(rect2i.origin().f2692x + ((rect2i.width() - min) / 2), ((rect2i.height() - min2) / 2) + rect2i.origin().f2693y, min, min2);
    }
    ...
    public static void writeRectangle(Rect2f rect2f, FloatBuffer floatBuffer) {
        writeRectangle(rect2f.origin().f2690x, rect2f.origin().f2691y, rect2f.width(), rect2f.height(), floatBuffer);
    }
    ...
    public static void writeRectangleLines(Rect2f rect2f, FloatBuffer floatBuffer) {
        writeRectangleLines(rect2f.origin().f2690x, rect2f.origin().f2691y, rect2f.width(), rect2f.height(), floatBuffer);
    }
}
