...
public class GLFramebufferObject implements Closeable {
    ...
    public void attachAsDraw(int i, GLTexture2D gLTexture2D) {
        GLES30.glFramebufferTexture2D(36009, 36064 + i, 3553, gLTexture2D.mo5500id(), 0);
    }

    public void attachAsRead(int i, GLTexture2D gLTexture2D) {
        GLES30.glFramebufferTexture2D(36008, 36064 + i, 3553, gLTexture2D.mo5500id(), 0);
    }

    public void attachLayerAsDraw(int i, GLTexture2DArray gLTexture2DArray, int i2) {
        GLES30.glFramebufferTextureLayer(36009, 36064 + i, gLTexture2DArray.mo5500id(), 0, i2);
    }

    public void attachLayerAsRead(int i, GLTexture2DArray gLTexture2DArray, int i2) {
        GLES30.glFramebufferTextureLayer(36008, 36064 + i, gLTexture2DArray.mo5500id(), 0, i2);
    }

    public void bindAsDraw() {
        GLES30.glBindFramebuffer(36009, this.f2673id);
    }

    public void bindAsDrawAndRead() {
        GLES30.glBindFramebuffer(36160, this.f2673id);
    }

    public void bindAsRead() {
        GLES30.glBindFramebuffer(36008, this.f2673id);
    }
    ...
    public void clearColorFixedPoint(int i, Vector4f vector4f) {
        clearColorFixedPoint(i, new float[]{vector4f.f2705x, vector4f.f2706y, vector4f.f2707z, vector4f.f2704w});
    }
    ...
    public void clearColorFloat(int i, Vector4f vector4f) {
        clearColorFloat(i, new float[]{vector4f.f2705x, vector4f.f2706y, vector4f.f2707z, vector4f.f2704w});
    }
    ...
    public void clearColorSignedInteger(int i, Vector4i vector4i) {
        clearColorSignedInteger(i, new int[]{vector4i.f2709x, vector4i.f2710y, vector4i.f2711z, vector4i.f2708w});
    }
    ...
    public void clearColorUnsignedInteger(int i, Vector4i vector4i) {
        clearColorUnsignedInteger(i, new int[]{vector4i.f2709x, vector4i.f2710y, vector4i.f2711z, vector4i.f2708w});
    }
    ...
    public void close() {
        GLES30.glDeleteFramebuffers(1, new int[]{this.f2673id}, 0);
        this.f2673id = 0;
    }
