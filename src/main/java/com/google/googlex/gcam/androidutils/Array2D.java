...
public class Array2D {
    ...
    public class F32x4 extends Array2D {
        ...
        public F32x4 cropped(int i, int i2, int i3, int i4) {
            ...
            jri.m13397a(z, "x >= 0, %s", i);
            if (i2 >= 0) {
                z = true;
            } else {
                z = false;
            }
            jri.m13397a(z, "y >= 0, %s", i2);
            if (i3 > 0) {
                z = true;
            } else {
                z = false;
            }
            jri.m13397a(z, "width > 0, %s", i3);
            if (i4 > 0) {
                z = true;
            } else {
                z = false;
            }
            jri.m13397a(z, "height > 0, %s", i4);
            if (i + i3 <= width()) {
                z = true;
            } else {
                z = false;
            }
            jri.m13402a(z, "x + width <= width(): %s + %s <= %s", Integer.valueOf(i), Integer.valueOf(i3), Integer.valueOf(width()));
            if (i2 + i4 > height()) {
                z2 = false;
            }
            jri.m13402a(z2, "y + height <= height(): %s + %s <= %s", Integer.valueOf(i2), Integer.valueOf(i4), Integer.valueOf(height()));
        ...
        public void set(int i, int i2, Vector4f vector4f) {
            set(i, i2, vector4f.f2705x, vector4f.f2706y, vector4f.f2707z, vector4f.f2704w);
        }
    }
    ...
    public class S32x4 extends Array2D {
        ...
        public void set(int i, int i2, Vector4i vector4i) {
            set(i, i2, vector4i.f2709x, vector4i.f2710y, vector4i.f2711z, vector4i.f2708w);
        }
    }
    ...
    public class U8x4 extends Array2D {
        ...
        public void set(int i, int i2, Vector4b vector4b) {
            set(i, i2, vector4b.f2701x, vector4b.f2702y, vector4b.f2703z, vector4b.f2700w);
        }
    }
    ...
    protected Array2D(int i, int i2, int i3, int i4, int i5) {
        ...
        jri.m13397a(z, "width must be positive: %s", i);
        if (i2 > 0) {
            z = true;
        } else {
            z = false;
        }
        jri.m13397a(z, "height must be positive: %s", i2);
        if (i3 > 0) {
            z = true;
        } else {
            z = false;
        }
        jri.m13397a(z, "elementSizeBytes must be positive: %s", i3);
        if (i4 > 0) {
            z = true;
        } else {
            z = false;
        }
        jri.m13397a(z, "elementStrideBytes must be positive: %s", i4);
        if (i4 >= i3) {
            z = true;
        } else {
            z = false;
        }
        jri.m13398a(z, "elementStrideBytes must be at least as big as elementSizeBytes: %s >= %s", i4, i3);
        if (i5 > 0) {
            z = true;
        } else {
            z = false;
        }
        jri.m13397a(z, "rowStrideBytes must be positive: %s", i5);
        if (i5 < i * i4) {
            z2 = false;
        }
        jri.m13402a(z2, "rowStrideBytes %s should be greater than or equal to width * elementStrideBytes: %s * %s ", Integer.valueOf(i5), Integer.valueOf(i), Integer.valueOf(i4));
        this.width = i;
        this.height = i2;
    ...
    protected Array2D(int i, int i2, int i3, int i4, int i5, ByteBuffer byteBuffer, int i6) {
        ...
        jri.m13397a(z, "elementSizeBytes must be positive: %s", i3);
        jri.m13391a((Object) byteBuffer, (Object) "buffer must not be null.");
        if (i6 < 0) {
            z2 = false;
        }
        jri.m13397a(z2, "originIndex %s must be >= 0.", i6);
        this.width = i;
        this.height = i2;
        this.elementSizeBytes = i3;
        this.elementStrideBytes = i4;
