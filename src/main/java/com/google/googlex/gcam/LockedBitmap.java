...
public class LockedBitmap implements AutoCloseable {
    ...
    private LockedBitmap(Bitmap bitmap) {
        boolean z;
        this.bitmap = (Bitmap) jri.m13404b((Object) bitmap);
        jri.m13400a(bitmap.getConfig().equals(Config.ARGB_8888), "Bitmap Config must be ARGB_8888", bitmap.getConfig());
        ...
        jri.m13398a(z, "Bitmap's row padding in bytes (%s) must evenly divide the number of channels (%s)", rowBytes, 4);
