...
class C0684gx extends C0261ha {
    ...
    /* JADX WARNING: Missing block: B:40:?, code:
            r3.close();
     */
    /* JADX WARNING: Missing block: B:46:0x005b, code:
            r3 = move-exception;
     */
     ...
     */
    /* renamed from: a */
    public android.graphics.Typeface mo7594a(android.content.Context r6, p000.C0273hq[] r7, int r8) {
        /*
        r5 = this;
        r0 = 0;
        r1 = r7.length;
    ...
    L_0x0004:
        return r0;
    L_0x0005:
        r1 = p000.C0261ha.m3015a(r7, r8);
        r2 = r6.getContentResolver();
        r1 = r1.f6806a;	 Catch:{ IOException -> 0x004d }
        r3 = "r";
        r4 = 0;
        r2 = r2.openFileDescriptor(r1, r3, r4);	 Catch:{ IOException -> 0x004d }
        r1 = p000.C0684gx.m11865a(r2);	 Catch:{ all -> 0x0044 }
    ...
    L_0x0022:
        ...
        r1 = p000.C0261ha.m3011a(r6, r3);	 Catch:{ all -> 0x004f }
    ...
    L_0x0056:
        r2 = move-exception;
        p000.kqg.m5105a(r1, r2);	 Catch:{ IOException -> 0x004d }
        goto L_0x004c;
    L_0x005b:
        r3 = move-exception;
        p000.kqg.m5105a(r1, r3);	 Catch:{ all -> 0x0044 }
        goto L_0x0055;
        */
    ...
    /* renamed from: a */
    private static File m11865a(ParcelFileDescriptor parcelFileDescriptor) {
        try {
