...
public final class acr implements Closeable {
    ...
    /* renamed from: a */
    final synchronized void mo136a(acu acu, boolean z) {
        int i = 0;
        synchronized (this) {
            acv acv = acu.f271a;
            if (acv.f280f != acu) {
            ...
            if ((acv.f279e | z) == 0) {
                ...
                this.f258c.append(10);
            } else {
                acv.f279e = true;
                this.f258c.append("CLEAN");
                this.f258c.append(' ');
                this.f258c.append(acv.f275a);
                this.f258c.append(acv.mo149a());
                this.f258c.append(10);
                if (z) {
                    this.f267l++;
                }
            ...
            this.f258c.flush();
            if (this.f265j > this.f264i || mo137a()) {
    ...
    /* renamed from: a */
    public final synchronized acu mo135a(String str) {
        acu acu;
        acv acv;
        m128d();
    ...
    /* renamed from: b */
    public final synchronized acw mo138b(String str) {
        acw acw;
        m128d();
    ...
    /* JADX WARNING: Removed duplicated region for block: B:102:0x0254 A:{Catch:{ NumberFormatException -> 0x0289, EOFException -> 0x0163 }} */
    /* JADX WARNING: Removed duplicated region for block: B:71:0x01d6 A:{Catch:{ NumberFormatException -> 0x0289, EOFException -> 0x0163 }} */
    /* JADX WARNING: Removed duplicated region for block: B:91:0x0228 A:{Catch:{ NumberFormatException -> 0x0289, EOFException -> 0x0163 }} */
    /* JADX WARNING: Missing block: B:37:0x014c, code:
            r0 = java.lang.String.valueOf(r6);
            r6 = "unexpected journal line: ";
     */
    /* JADX WARNING: Missing block: B:38:0x0158, code:
            if (r0.length() != 0) goto L_0x0283;
     */
    /* JADX WARNING: Missing block: B:39:0x015a, code:
            r0 = new java.lang.String(r6);
     */
    /* JADX WARNING: Missing block: B:41:0x0162, code:
    ...
    L_0x003b:
        ...
        r0 = r5.mo150a();	 Catch:{ all -> 0x00e7 }
        r2 = r5.mo150a();	 Catch:{ all -> 0x00e7 }
        r4 = r5.mo150a();	 Catch:{ all -> 0x00e7 }
        r6 = r5.mo150a();	 Catch:{ all -> 0x00e7 }
        r7 = r5.mo150a();	 Catch:{ all -> 0x00e7 }
    ...
    L_0x013f:
        r4 = r3;
    L_0x0140:
        r6 = r5.mo150a();	 Catch:{ EOFException -> 0x0163 }
        r0 = 32;
    ...
    /* renamed from: b */
    final synchronized void mo139b() {
    ...
    /* renamed from: c */
    public final synchronized boolean mo141c(String str) {
        boolean z;
        int i = 0;
        synchronized (this) {
            m128d();
    ...
    final void mo140c() {
        while (this.f265j > this.f264i) {
            mo141c((String) ((Entry) this.f266k.entrySet().iterator().next()).getKey());
        }
    }
}
