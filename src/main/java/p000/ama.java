...
public final class ama implements ImageHeaderParser {
    /* renamed from: a */
    private static final byte[] f10397a = "Exif\u0000\u0000".getBytes(Charset.forName("UTF-8"));
    /* renamed from: b */
    private static final int[] f10398b = new int[]{0, 1, 1, 2, 4, 8, 1, 1, 2, 4, 8, 4, 8};

    /* renamed from: a */
    private static int m6687a(amd amd, agu agu) {
        int i;
        int i2 = 1;
        short s = (short) 0;
        int i3 = -1;
        ...
        if (i != 0) {
            ...
            if (b != -1) {
                Object obj = (byte[]) agu.mo272a(b, byte[].class);
                try {
                    int a2 = amd.mo364a(obj, b);
                    if (a2 == b) {
                        if (obj == null) {
                            i2 = 0;
                        } else if (b <= f10397a.length) {
                            i2 = 0;
                        }
                        if (i2 != 0) {
                            for (a2 = 0; a2 < f10397a.length; a2++) {
                                if (obj[a2] != f10397a[a2]) {
                                    i2 = 0;
                                    break;
                                }
                            }
                        ...
                        if (i2 != 0) {
                            ...
                            while (s < c) {
                                int i4 = (i2 + 2) + (s * 12);
                                short a4 = amc.mo361a(i4);
                                if (a4 == (short) 274) {
                                    short a5 = amc.mo361a(i4 + 2);
                                    StringBuilder stringBuilder3;
                                    if (a5 > (short) 0 && a5 <= (short) 12) {
                                        int b2 = amc.mo362b(i4 + 4);
                                        if (b2 >= 0) {
                                            if (Log.isLoggable("DfltImageHeaderParser", 3)) {
    ...
    /* renamed from: a */
    public final int mo2417a(InputStream inputStream, agu agu) {
        return ama.m6687a(new ame((InputStream) aqe.m610a((Object) inputStream, "Argument must not be null")), (agu) aqe.m610a((Object) agu, "Argument must not be null"));
    }

    /* renamed from: a */
    private static ImageType m6688a(amd amd) {
        int b = amd.mo366b();
        if (b == 65496) {
            return ImageType.JPEG;
        }
        b = ((b << 16) & -65536) | ((char) amd.mo366b());
        if (b == -1991225785) {
            amd.mo365a(21);
            return amd.mo363a() < 3 ? ImageType.PNG : ImageType.PNG_A;
        } else if ((b >> 8) == 4671814) {
            ...
            amd.mo365a(4);
            if ((((amd.mo366b() << 16) & -65536) | ((char) amd.mo366b())) != 1464156752) {
                return ImageType.UNKNOWN;
            }
            b = ((amd.mo366b() << 16) & -65536) | ((char) amd.mo366b());
            if ((b & -256) != 1448097792) {
                return ImageType.UNKNOWN;
            }
            b &= Illuminant.kOther;
            if (b == 88) {
                amd.mo365a(4);
                return (amd.mo363a() & 16) == 0 ? ImageType.WEBP : ImageType.WEBP_A;
            } else if (b != 76) {
                return ImageType.WEBP;
            } else {
                amd.mo365a(4);
                return (amd.mo363a() & 8) == 0 ? ImageType.WEBP : ImageType.WEBP_A;
            }
        }
    }

    /* renamed from: a */
    public final ImageType mo2418a(InputStream inputStream) {
        return ama.m6688a(new ame((InputStream) aqe.m610a((Object) inputStream, "Argument must not be null")));
    }

    /* renamed from: a */
    public final ImageType mo2419a(ByteBuffer byteBuffer) {
        return ama.m6688a(new amb((ByteBuffer) aqe.m610a((Object) byteBuffer, "Argument must not be null")));
    }
}
