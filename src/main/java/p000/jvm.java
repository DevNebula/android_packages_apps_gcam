...
public final class jvm {
    ...
    protected jvm(float[] fArr, float[] fArr2, long[] jArr, List list, jvk jvk, float f, float f2) {
        ...
        this.f8371f = jvk;
        this.f8372g = f;
        this.f8369d = (int) Math.ceil((double) (10.0f * f2));
    }

    /* renamed from: a */
    final double mo9572a(int i, int i2) {
        if (i > i2) {
            throw new IllegalArgumentException("Cluster must have at least one element!");
        }
        double[] a = jvm.m4709a(this.f8366a, i, i2);
        double[] a2 = jvm.m4709a(this.f8370e, i, i2);
        ...
        return ((double) this.f8372g) + d;
    }

    /* renamed from: a */
    private static double[] m4709a(float[] fArr, int i, int i2) {
