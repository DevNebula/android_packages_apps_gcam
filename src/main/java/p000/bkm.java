...
public final class bkm {
    ...
    public bkm(AudioManager audioManager) {
        this.f1269a = audioManager;
    }

    /* renamed from: a */
    public final AudioDeviceInfo mo1994a() {
        AudioDeviceInfo audioDeviceInfo = null;
        AudioDeviceInfo[] devices = this.f1269a.getDevices(1);
        ...
        while (i < length) {
            ...
            String valueOf = String.valueOf(bkm.m871a(audioDeviceInfo4));
            String str = "Found: ";
            if (valueOf.length() == 0) {
            ...
            if (audioDeviceInfo4.getType() == 11 || audioDeviceInfo4.getType() == 22) {
                valueOf = String.valueOf(bkm.m871a(audioDeviceInfo4));
    ...
    /* renamed from: a */
    public static String m871a(AudioDeviceInfo audioDeviceInfo) {
        if (audioDeviceInfo == null) {
