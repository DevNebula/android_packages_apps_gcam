...
public final class aca {
    ...
    /* renamed from: a */
    public final CaptureRequest mo104a(CameraDevice cameraDevice, int i, Surface... surfaceArr) {
    ...
    /* renamed from: a */
    public final boolean mo105a(Key key, Object obj) {
        return Objects.equals(m93a(key), obj);
    }

    /* renamed from: b */
    public final boolean mo106b(Key key, Object obj) {
        if (key == null) {
            throw new NullPointerException("Received a null key");
        }
        Object a = m93a(key);
