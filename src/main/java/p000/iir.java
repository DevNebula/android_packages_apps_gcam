...
public class iir {
    ...
    /* renamed from: a */
    public static iir m3816a(Context context) {
        htl.m3488b((Object) context);
        synchronized (iir.class) {
            if (f7374a == null) {
                f7374a = new iir(context);
            }
        }
        return f7374a;
    }
    ...
    /* renamed from: a */
    private static boolean m3817a(PackageInfo packageInfo, boolean z) {
        if (packageInfo.signatures.length == 1) {
            packageInfo.signatures[0].toByteArray();
            if (z) {
                return iir.m3818a(packageInfo, f7375c, f7376d);
            }
            return iir.m3818a(packageInfo, f7375c);
        }
    ...
    /* renamed from: a */
    private static boolean m3818a(PackageInfo packageInfo, byte[]... bArr) {
    ...
    /* renamed from: b */
    private static byte[] m3819b(String str) {
        try {
    ...
    /* renamed from: c */
    private final PackageInfo m3820c(String str) {
        try {
            return iad.f7237a.mo8300a(this.f7377b).mo8299b(str, 64);
    ...
    /* renamed from: a */
    public final boolean mo8511a(String str) {
        PackageInfo c = m3820c(str);
        if (c == null) {
            return false;
        }
        if (hue.m3523d(this.f7377b)) {
            return iir.m3817a(c, true);
        }
        boolean a = iir.m3817a(c, false);
        if (a || !iir.m3817a(c, true)) {
            return a;
        }
