...
final class ftp {
    ...
    /* renamed from: a */
    public final OutputStream mo6905a(String str, String str2) {
        File file = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM), this.f4942a);
