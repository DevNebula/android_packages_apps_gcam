...
public final class gwu extends gwz {
    ...
    public final void mo7586a(long j, long j2, Canvas canvas) {
        ...
        if (this.f19789n != C0252go.f5888bh) {
            ...
            if (this.f19789n == C0252go.f5890bj) {
                this.f19779d.mo7584a();
            }
        ...
        if (mo7587a()) {
            ...
            if (this.f19789n == C0252go.f5889bi) {
                a2 = (int) ((this.f19780e.mo7591a(gzj.m11912a(j, this.f19786k, this.f19782g)) * 255.0f) + 0.0f);
            } else if (this.f19789n == C0252go.f5891bk) {
