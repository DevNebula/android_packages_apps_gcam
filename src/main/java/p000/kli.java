...
public final class kli extends kvf {
     ...
     */
    /* renamed from: a */
    private final p000.kli m16942a(p000.kvc r7) {
        /*
        r6 = this;
    L_0x0000:
        r0 = r7.mo10488i();
    ...
    L_0x001b:
        ...
        r2 = " is not a valid enum RetryResult";
        r4.append(r2);	 Catch:{ IllegalArgumentException -> 0x0034 }
    ...
    L_0x0034:
        ...
        goto L_0x0000;
    L_0x003c:
        r6.f25254a = r2;	 Catch:{ IllegalArgumentException -> 0x0034 }
        goto L_0x0000;
        */
        throw new UnsupportedOperationException("Method not decompiled: kli.a(kvc):kli");
    }
