...
final class cfz implements Runnable {
    /* renamed from: a */
    private final /* synthetic */ cfk f2114a;
    ...
    public final void run() {
        ...
        long j2;
        long j3;
        erh erh = this.f2114a.f23176k;
        int memoryClass = erh.f4341b.getMemoryClass();
        int largeMemoryClass = erh.f4341b.getLargeMemoryClass();
        MemoryInfo memoryInfo = new MemoryInfo();
        erh.f4341b.getMemoryInfo(memoryInfo);
        ...
        if (myPid != 0) {
            Debug.MemoryInfo[] processMemoryInfo = erh.f4341b.getProcessMemoryInfo(new int[]{myPid});
        ...
        bli.m888a(erh.f4340a, String.format(Locale.US, "timestamp=%d, availMem=%d, totalMem=%d, totalPSS=%d, lastTrimLevel=%d, largeMemoryClass=%d, nativePSS=%d, dalvikPSS=%d, otherPSS=%d,threshold=%d, lowMemory=%s", new Object[]{r26, r18, r19, r10, Integer.valueOf(runningAppProcessInfo.lastTrimLevel), r11, r8, r6, r4, r5, r7}));
        this.f2114a.f23069Q.mo8902a(hashMap, "launch");
    }
}
