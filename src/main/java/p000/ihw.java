...
final class ihw {
    /* renamed from: a */
    public final Map f7371a = new HashMap();

    ihw() {
    }

    /* renamed from: a */
    public final void mo8491a(IBinder iBinder) {
        synchronized (this.f7371a) {
            iht a = ihu.m12467a(iBinder);
            iho iil = new iil();
            for (Entry entry : this.f7371a.entrySet()) {
                iip iip = (iip) entry.getValue();
                try {
                    a.mo8489a(iil, new zzc(iip));
