...
public final class afc {
    ...
    final List mo222b() {
        if (!this.f379l) {
            this.f379l = true;
            this.f368a.clear();
            List a = this.f370c.f211d.mo121a(this.f371d);
            int size = a.size();
            for (int i = 0; i < size; i++) {
                aka a2 = ((ajz) a.get(i)).mo343a(this.f371d, this.f372e, this.f373f, this.f376i);
                if (a2 != null) {
                    this.f368a.add(a2);
                }
            }
    ...
    /* renamed from: a */
    final agk mo218a(Class cls) {
        return this.f370c.f211d.mo119a(cls, this.f374g, this.f378k);
    }

    /* renamed from: a */
    final List mo220a(File file) {
        return this.f370c.f211d.mo121a((Object) file);
    }

    /* renamed from: b */
    final ads mo221b(Class cls) {
    ...
    /* renamed from: c */
    final boolean mo223c(Class cls) {
        return mo218a(cls) != null;
    }
}
