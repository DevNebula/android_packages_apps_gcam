...
final class C0379nb {
    ...
    /* renamed from: a */
    public final void mo10701a(long j, double d, double d2) {
        ...
        if (d3 >= 1.0d) {
            ...
            this.f9232b = Math.round((round + d3) * 8.64E7d) + 946728000000L;
            this.f9233c = Math.round((round - d3) * 8.64E7d) + 946728000000L;
            if (this.f9233c >= j || this.f9232b <= j) {
                this.f9234d = 1;
            } else {
                this.f9234d = 0;
            }
