...
final class hyq extends hyw {
    /* renamed from: a */
    private final /* synthetic */ Bundle f26700a;
    /* renamed from: b */
    private final /* synthetic */ long f26701b;
    /* renamed from: c */
    private final /* synthetic */ GoogleHelp f26702c;

    hyq(huq huq, Bundle bundle, long j, GoogleHelp googleHelp) {
        this.f26700a = bundle;
        this.f26701b = j;
        this.f26702c = googleHelp;
        super(huq, (byte) 0);
    }
    ...
    protected final void mo15551a(hyy hyy) {
        Parcel obtain;
        try {
            Bundle bundle = this.f26700a;
            long j = this.f26701b;
            GoogleHelp googleHelp = this.f26702c;
            ...
            hyy.f7192a.transact(8, obtain, null, 1);
            obtain.recycle();
        } catch (Throwable e) {
