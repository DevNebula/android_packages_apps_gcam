...
public final class hii {
    /* renamed from: a */
    public hir f6594a = hir.PORTRAIT;
    ...
    /* renamed from: b */
    private static int m3230b(hir hir) {
        switch (hir.ordinal()) {
            case 0:
                return 0;
            case 1:
    ...
    /* renamed from: c */
    private static boolean m3231c(hir hir) {
        return hir == hir.LANDSCAPE || hir == hir.REVERSE_LANDSCAPE;
    }

    /* renamed from: a */
    public static boolean m3228a(hir hir) {
        return hir == hir.LANDSCAPE || hir == hir.REVERSE_PORTRAIT;
    }

    /* renamed from: a */
    private static int[] m3229a(int[] iArr, int i) {
    ...
    /* renamed from: a */
    public static void m3227a(hir hir, hir hir2, LinearLayout... linearLayoutArr) {
        for (LinearLayout linearLayout : linearLayoutArr) {
            if (!hir.equals(hir2)) {
                int childCount;
                int i;
                if (hii.m3228a(hir2) != hii.m3228a(hir)) {
                ...
                if (hii.m3231c(hir2) != hii.m3231c(hir)) {
                ...
                i = hii.m3230b(hir2) - hii.m3230b(hir);
                int[] a = hii.m3229a(new int[]{linearLayout.getPaddingLeft(), linearLayout.getPaddingTop(), linearLayout.getPaddingRight(), linearLayout.getPaddingBottom()}, i);
                ...
                if (linearLayout.getLayoutParams() != null) {
                    ...
                    int[] a2 = hii.m3229a(new int[]{marginLayoutParams.leftMargin, marginLayoutParams.topMargin, marginLayoutParams.rightMargin, marginLayoutParams.bottomMargin}, i);
    ...
    /* renamed from: a */
    public final void mo7881a(hir hir, LinearLayout... linearLayoutArr) {
        hii.m3227a(this.f6594a, hir, linearLayoutArr);
        this.f6594a = hir;
    }
}
