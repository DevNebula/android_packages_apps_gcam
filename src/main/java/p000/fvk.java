...
public final class fvk {
    static {
        bli.m887a("Face2LegacyFaceConv");
    }

    /* renamed from: a */
    public static Matrix m2453a(RectF rectF, int i, int i2, int i3, iqm iqm, boolean z, float f, float f2) {
        int height;
        int height2;
        float f3 = -1.0f;
        ...
        matrix.postRotate((float) (i3 - iqm.mo8806a()));
