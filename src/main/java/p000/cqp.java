...
public final class cqp {
    /* renamed from: a */
    private static final String f2771a = bli.m887a("VideoDataFact");
    /* renamed from: b */
    private static final iqp f2772b = new iqp(-2, -2);

    cqp() {
    }

    /* renamed from: a */
    public static cqv m1457a(Cursor cursor) {
        iqp iqp;
        ...
        if (i == 0 || i2 == 0) {
            ...
            if (camcorderProfile != null) {
                ...
                bli.m898e(f2771a, "Video profile was null, defaulting to unknown width and height.");
                iqp = f2772b;
            }
        } else {
            iqp = new iqp(i, i2);
        ...
        return new cqv(j, string, string2, date, date2, string3, cqr.f2773a.buildUpon().appendPath(String.valueOf(j)).build(), false, iqp, j4, erx.m2135a(d, d2), j5);
    }
}
