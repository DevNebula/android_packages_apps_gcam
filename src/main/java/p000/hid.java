...
public final class hid {
    /* renamed from: a */
    private static final String f6588a = bli.m887a("BitmapUtil");

    /* renamed from: a */
    public static Bitmap m3223a(Drawable drawable) {
    ...
    /* renamed from: a */
    public static Bitmap m3221a(Bitmap bitmap) {
    ...
    /* renamed from: b */
    public static Bitmap m3225b(Drawable drawable) {
        return hid.m3223a(drawable);
    }

    /* renamed from: a */
    public static Bitmap m3222a(Bitmap bitmap, Size size) {
        int width = bitmap.getWidth();
        int height = bitmap.getHeight();
    ...
    /* renamed from: b */
    public static Bitmap m3224b(Bitmap bitmap) {
        int i = 512;
        int width = bitmap.getWidth();
        int height = bitmap.getHeight();
        String str = f6588a;
