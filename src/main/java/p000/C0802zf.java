...
/* compiled from: PG */
/* renamed from: zf */
final class C0802zf extends abu implements ErrorCallback {
    /* renamed from: a */
    private C0619zs f22464a;
    /* renamed from: b */
    private Camera f22465b;
    /* renamed from: c */
    private int f22466c = -1;
    /* renamed from: d */
    private C0610zh f22467d;
    /* renamed from: e */
    private int f22468e = 0;
    /* renamed from: f */
    private final /* synthetic */ C0796yo f22469f;

    C0802zf(C0796yo c0796yo, C0619zs c0619zs, Looper looper) {
        this.f22469f = c0796yo;
        super(looper);
        this.f22464a = c0619zs;
    }

    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:zf.handleMessage(android.os.Message):void, dom blocks: [B:4:0x0037, B:10:0x006f, B:109:0x037c]
    ...
    L_0x0011:
        r3 = p000.C0796yo.f22440a;
        r5 = new java.lang.StringBuilder;
        r5.<init>();
        r6 = "handleMessage - action = '";
        r5.append(r6);
        r6 = r12.what;
        r6 = p000.C0509tz.m5938a(r6);
        r5.append(r6);
        r6 = "'";
        r5.append(r6);
        r5 = r5.toString();
    ...
    L_0x0037:
        r2 = p000.C0796yo.f22440a;	 Catch:{ RuntimeException -> 0x006e }
    ...
    L_0x0052:
        return;
    L_0x0053:
        r2 = r11.f22469f;	 Catch:{ RuntimeException -> 0x006e }
        r2 = r2.f22445e;	 Catch:{ RuntimeException -> 0x006e }
        r3 = 8;	 Catch:{ RuntimeException -> 0x006e }
        r2.mo78a(r3);	 Catch:{ RuntimeException -> 0x006e }
        r2 = r12.obj;	 Catch:{ RuntimeException -> 0x006e }
        r2 = (p000.C0609zg) r2;	 Catch:{ RuntimeException -> 0x006e }
        r3 = r11.f22465b;	 Catch:{ RuntimeException -> 0x006e }
        r4 = r2.f10081a;	 Catch:{ RuntimeException -> 0x006e }
        r5 = r2.f10082b;	 Catch:{ RuntimeException -> 0x006e }
        r6 = r2.f10083c;	 Catch:{ RuntimeException -> 0x006e }
        r2 = r2.f10084d;	 Catch:{ RuntimeException -> 0x006e }
        r3.takePicture(r4, r5, r6, r2);	 Catch:{ RuntimeException -> 0x006e }
        goto L_0x004f;
    L_0x006e:
        r2 = move-exception;
        r3 = r11.f22469f;	 Catch:{ all -> 0x00f1 }
        r3 = r3.f22445e;	 Catch:{ all -> 0x00f1 }
        r4 = r3.mo77a();	 Catch:{ all -> 0x00f1 }
        ...
        r5 = p000.C0509tz.m5938a(r10);	 Catch:{ all -> 0x00f1 }
        r3.append(r5);	 Catch:{ all -> 0x00f1 }
        ...
        r5 = p000.C0796yo.f22440a;	 Catch:{ all -> 0x00f1 }
        ...
        r3 = r11.f22469f;	 Catch:{ all -> 0x00f1 }
        r3 = r3.f22445e;	 Catch:{ all -> 0x00f1 }
        r3.mo79b();	 Catch:{ all -> 0x00f1 }
        r3 = r11.f22465b;	 Catch:{ all -> 0x00f1 }
    ...
    L_0x00c8:
        r2 = r12.obj;	 Catch:{ all -> 0x00f1 }
        r2 = (p000.C0625zy) r2;	 Catch:{ all -> 0x00f1 }
        r4 = r12.arg1;	 Catch:{ all -> 0x00f1 }
        r3 = r11.mo86b(r3);	 Catch:{ all -> 0x00f1 }
        r2.mo11603a(r4, r3);	 Catch:{ all -> 0x00f1 }
    L_0x00d5:
        p000.aaw.m27a(r12);
        goto L_0x0052;
    L_0x00da:
        r2 = r11.f22467d;	 Catch:{ RuntimeException -> 0x006e }
        r2 = r2.mo11579a();	 Catch:{ RuntimeException -> 0x006e }
        ...
        r2 = r11.f22467d;	 Catch:{ RuntimeException -> 0x006e }
        r2.mo11580b();	 Catch:{ RuntimeException -> 0x006e }
        goto L_0x004f;
    L_0x00f1:
        r2 = move-exception;
        p000.aaw.m27a(r12);
    ...
    L_0x00f6:
        r3 = r11.f22465b;	 Catch:{ RuntimeException -> 0x006e }
        r4 = r11.f22469f;	 Catch:{ RuntimeException -> 0x006e }
        r4 = r4.f22442b;	 Catch:{ RuntimeException -> 0x006e }
        r5 = r12.arg1;	 Catch:{ RuntimeException -> 0x006e }
        r6 = 1;	 Catch:{ RuntimeException -> 0x006e }
        r4 = r4.mo55a(r5, r6);	 Catch:{ RuntimeException -> 0x006e }
        r3.setDisplayOrientation(r4);	 Catch:{ RuntimeException -> 0x006e }
        r3 = r11.f22467d;	 Catch:{ RuntimeException -> 0x006e }
        r3 = r3.mo11579a();	 Catch:{ RuntimeException -> 0x006e }
    ...
    L_0x0110:
        ...
        r2 = r11.f22465b;	 Catch:{ RuntimeException -> 0x006e }
    ...
    L_0x011f:
        r2 = r11.f22469f;	 Catch:{ RuntimeException -> 0x006e }
        r2 = r2.f22442b;	 Catch:{ RuntimeException -> 0x006e }
        r4 = r12.arg1;	 Catch:{ RuntimeException -> 0x006e }
        r5 = 0;	 Catch:{ RuntimeException -> 0x006e }
        r2 = r2.mo55a(r4, r5);	 Catch:{ RuntimeException -> 0x006e }
    ...
    L_0x0145:
        ...
        goto L_0x004f;	 Catch:{ RuntimeException -> 0x006e }
    L_0x0150:
        r2 = r11.f22468e;	 Catch:{ RuntimeException -> 0x006e }
        r2 = r2 + -1;	 Catch:{ RuntimeException -> 0x006e }
        r11.f22468e = r2;	 Catch:{ RuntimeException -> 0x006e }
        goto L_0x004f;	 Catch:{ RuntimeException -> 0x006e }
    L_0x0158:
        r3 = r11.f22465b;	 Catch:{ RuntimeException -> 0x006e }
        r2 = r12.obj;	 Catch:{ RuntimeException -> 0x006e }
    ...
    L_0x016e:
        r2 = move-exception;
        r3 = p000.C0796yo.f22440a;	 Catch:{ RuntimeException -> 0x006e }
    ...
    L_0x0193:
        ...
        r3.append(r4);	 Catch:{ RuntimeException -> 0x006e }
        r4 = r11.f22468e;	 Catch:{ RuntimeException -> 0x006e }
        r3.append(r4);	 Catch:{ RuntimeException -> 0x006e }
    ...
    L_0x01c6:
        r2 = r11.f22467d;	 Catch:{ RuntimeException -> 0x006e }
        r5 = r2.mo11579a();	 Catch:{ RuntimeException -> 0x006e }
        r2 = r12.obj;	 Catch:{ RuntimeException -> 0x006e }
        r2 = (p000.abo) r2;	 Catch:{ RuntimeException -> 0x006e }
        r3 = r11.f22469f;	 Catch:{ RuntimeException -> 0x006e }
        r3 = r3.f22443c;	 Catch:{ RuntimeException -> 0x006e }
        r3 = r3.f69w;	 Catch:{ RuntimeException -> 0x006e }
        r3 = r2.mo72b();	 Catch:{ RuntimeException -> 0x006e }
        ...
        r3 = r2.mo74c();	 Catch:{ RuntimeException -> 0x006e }
        r3 = r3.f178a;	 Catch:{ RuntimeException -> 0x006e }
        r6 = r3.x;	 Catch:{ RuntimeException -> 0x006e }
        r3 = r3.y;	 Catch:{ RuntimeException -> 0x006e }
    ...
    L_0x01f7:
        ...
        r3 = r3.mo46a(r6);	 Catch:{ RuntimeException -> 0x006e }
    ...
    L_0x024d:
        r3 = r2.mo75d();	 Catch:{ RuntimeException -> 0x006e }
    ...
    L_0x026a:
        r3 = r2.mo76e();	 Catch:{ RuntimeException -> 0x006e }
        r3 = r3.size();	 Catch:{ RuntimeException -> 0x006e }
    ...
    L_0x034d:
        r2 = r11.f22467d;	 Catch:{ RuntimeException -> 0x006e }
        r3 = r2.mo11579a();	 Catch:{ RuntimeException -> 0x006e }
        r2 = r12.obj;	 Catch:{ RuntimeException -> 0x006e }
    ...
    L_0x0371:
        ...
        goto L_0x004f;
    L_0x037c:
        r3 = r11.f22465b;	 Catch:{ IOException -> 0x0387 }
    ...
    L_0x03b6:
        r2.mo42a();	 Catch:{ RuntimeException -> 0x006e }
        goto L_0x004f;	 Catch:{ RuntimeException -> 0x006e }
    L_0x03bb:
        r2 = r12.obj;	 Catch:{ RuntimeException -> 0x006e }
        r3 = r11.f22465b;	 Catch:{ IOException -> 0x03c6 }
    ...
    L_0x03ee:
        ...
        r0 = (p000.C0805zz) r0;	 Catch:{ RuntimeException -> 0x006e }
        r8 = r0;	 Catch:{ RuntimeException -> 0x006e }
        r5 = r12.arg1;	 Catch:{ RuntimeException -> 0x006e }
        r2 = r11.f22465b;	 Catch:{ IOException -> 0x04e9 }
    ...
    L_0x0405:
        ...
        r3 = r11.f22469f;	 Catch:{ RuntimeException -> 0x006e }
        r6 = r3.f22442b;	 Catch:{ RuntimeException -> 0x006e }
        r7 = r3.f22443c;	 Catch:{ RuntimeException -> 0x006e }
        r4 = r3;	 Catch:{ RuntimeException -> 0x006e }
        r2.<init>(r3, r4, r5, r6, r7);	 Catch:{ RuntimeException -> 0x006e }
        r8.mo11604a(r2);	 Catch:{ RuntimeException -> 0x006e }
        goto L_0x004f;	 Catch:{ RuntimeException -> 0x006e }
    L_0x0416:
        r2 = r11.f22465b;	 Catch:{ RuntimeException -> 0x006e }
    ...
    L_0x041a:
        ...
        r11.f22465b = r2;	 Catch:{ RuntimeException -> 0x006e }
        r2 = -1;	 Catch:{ RuntimeException -> 0x006e }
        r11.f22466c = r2;	 Catch:{ RuntimeException -> 0x006e }
        goto L_0x004f;	 Catch:{ RuntimeException -> 0x006e }
    L_0x042d:
        r2 = p000.C0796yo.f22440a;	 Catch:{ RuntimeException -> 0x006e }
    ...
    L_0x0436:
        r2 = r12.obj;	 Catch:{ RuntimeException -> 0x006e }
        r0 = r2;	 Catch:{ RuntimeException -> 0x006e }
        r0 = (p000.C0625zy) r0;	 Catch:{ RuntimeException -> 0x006e }
        r8 = r0;	 Catch:{ RuntimeException -> 0x006e }
        r5 = r12.arg1;	 Catch:{ RuntimeException -> 0x006e }
        r2 = r11.f22469f;	 Catch:{ RuntimeException -> 0x006e }
        r2 = r2.f22445e;	 Catch:{ RuntimeException -> 0x006e }
        r2 = r2.mo77a();	 Catch:{ RuntimeException -> 0x006e }
        if (r2 == r9) goto L_0x0451;	 Catch:{ RuntimeException -> 0x006e }
    L_0x0448:
        r2 = r11.mo86b(r5);	 Catch:{ RuntimeException -> 0x006e }
        r8.mo11606b(r5, r2);	 Catch:{ RuntimeException -> 0x006e }
        goto L_0x004f;	 Catch:{ RuntimeException -> 0x006e }
    L_0x0451:
        r2 = p000.C0796yo.f22440a;	 Catch:{ RuntimeException -> 0x006e }
        r3 = new java.lang.StringBuilder;	 Catch:{ RuntimeException -> 0x006e }
    ...
    L_0x0476:
        r11.f22466c = r5;	 Catch:{ RuntimeException -> 0x006e }
        r3 = new zh;	 Catch:{ RuntimeException -> 0x006e }
        r3.<init>(r2);	 Catch:{ RuntimeException -> 0x006e }
        r11.f22467d = r3;	 Catch:{ RuntimeException -> 0x006e }
        r2 = r11.f22469f;	 Catch:{ RuntimeException -> 0x006e }
        r3 = p000.C0798ys.m14845b();	 Catch:{ RuntimeException -> 0x006e }
        r3 = r3.mo53a(r5);	 Catch:{ RuntimeException -> 0x006e }
        r2.f22442b = r3;	 Catch:{ RuntimeException -> 0x006e }
        r2 = r11.f22469f;	 Catch:{ RuntimeException -> 0x006e }
        r3 = new zo;	 Catch:{ RuntimeException -> 0x006e }
        r4 = r11.f22467d;	 Catch:{ RuntimeException -> 0x006e }
        r4 = r4.mo11579a();	 Catch:{ RuntimeException -> 0x006e }
        r3.<init>(r4);	 Catch:{ RuntimeException -> 0x006e }
        r2.f22443c = r3;	 Catch:{ RuntimeException -> 0x006e }
        r2 = r11.f22465b;	 Catch:{ RuntimeException -> 0x006e }
    ...
    L_0x04a9:
        r2 = new yu;	 Catch:{ RuntimeException -> 0x006e }
        r3 = r11.f22469f;	 Catch:{ RuntimeException -> 0x006e }
        r4 = r11.f22464a;	 Catch:{ RuntimeException -> 0x006e }
        r6 = r3.f22442b;	 Catch:{ RuntimeException -> 0x006e }
        r7 = r3.f22443c;	 Catch:{ RuntimeException -> 0x006e }
        r2.<init>(r3, r4, r5, r6, r7);	 Catch:{ RuntimeException -> 0x006e }
        r8.mo11604a(r2);	 Catch:{ RuntimeException -> 0x006e }
    ...
    L_0x04bd:
        r2 = r11.mo86b(r5);	 Catch:{ RuntimeException -> 0x006e }
        r8.mo11603a(r5, r2);	 Catch:{ RuntimeException -> 0x006e }
        goto L_0x004f;
    L_0x04c6:
        r2 = p000.C0796yo.f22440a;
    ...
    L_0x04ec:
        r2 = r11.f22464a;	 Catch:{ RuntimeException -> 0x006e }
        r3 = r11.f22466c;	 Catch:{ RuntimeException -> 0x006e }
        r3 = r11.mo86b(r3);	 Catch:{ RuntimeException -> 0x006e }
        r8.mo11605a(r2, r3);	 Catch:{ RuntimeException -> 0x006e }
        goto L_0x004f;
    L_0x04f9:
        r3 = p000.C0796yo.f22440a;	 Catch:{ all -> 0x00f1 }
        r5 = "Release camera since mCamera is not null.";	 Catch:{ all -> 0x00f1 }
        p000.abx.m89c(r3, r5);	 Catch:{ all -> 0x00f1 }
        r3 = r11.f22465b;	 Catch:{ Exception -> 0x051b }
        r3.release();	 Catch:{ Exception -> 0x051b }
        r3 = 0;
        r11.f22465b = r3;	 Catch:{ all -> 0x00f1 }
        goto L_0x00ba;	 Catch:{ all -> 0x00f1 }
    L_0x050a:
        r3 = r11.f22464a;	 Catch:{ all -> 0x00f1 }
        r3 = r3.mo11592b();	 Catch:{ all -> 0x00f1 }
        r5 = r11.f22466c;	 Catch:{ all -> 0x00f1 }
        r5 = r11.mo86b(r5);	 Catch:{ all -> 0x00f1 }
        r3.mo60a(r2, r5, r10, r4);	 Catch:{ all -> 0x00f1 }
        goto L_0x00d5;
    L_0x051b:
        r3 = move-exception;
        r5 = p000.C0796yo.f22440a;	 Catch:{ all -> 0x0528 }
    ...
    public final void onError(int i, Camera camera) {
        this.f22469f.f22447g.mo58a(i);
        if (i == 100) {
            this.f22469f.f22447g.mo60a(new RuntimeException("Media server died."), mo86b(this.f22466c), ((Integer) this.f176r.peekLast()).intValue(), this.f22469f.f22445e.mo77a());
        }
    }
}
