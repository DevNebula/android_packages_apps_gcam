...
public final class ivy {
    ...
    /* renamed from: a */
    public static ivy m4328a() {
        int i = 0;
        String str = Build.MANUFACTURER;
        String str2 = Build.DEVICE;
        String str3 = Build.FINGERPRINT;
        str = ivy.m4329a(str);
        String a = ivy.m4329a(str2);
        str2 = ivy.m4329a(str3);
        ...
        jri.m13397a(z, "expectedInputSize must be >= 0 but was %s", i2);
        kig a3 = a2.mo10017a();
        int length2 = toUpperCase.length();
        while (i < length2) {
            a3.mo10020a(toUpperCase.charAt(i));
            i++;
        }
        return new ivy(a3.mo10018a().mo10011c());
    }
