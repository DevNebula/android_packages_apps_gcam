...
public class aaz {
    ...
    /* renamed from: a */
    public final List mo45a() {
        return new ArrayList(this.f52f);
    }

    /* renamed from: b */
    public final List mo50b() {
        return new ArrayList(this.f48b);
    }

    /* renamed from: c */
    public final List mo51c() {
        return new ArrayList(this.f49c);
    }

    /* renamed from: a */
    public final boolean mo46a(aba aba) {
        return aba != null && this.f58l.contains(aba);
    }

    /* renamed from: a */
    public final boolean mo47a(abb abb) {
        return abb != null && this.f55i.contains(abb);
    }

    /* renamed from: a */
    public final boolean mo48a(abc abc) {
        return abc != null && this.f56j.contains(abc);
    }

    /* renamed from: a */
    public final boolean mo49a(abd abd) {
