...
public final class axl implements TimeInterpolator {
    ...
    public final float getInterpolation(float f) {
        ...
        int min = Math.min((int) (((float) (f1037b.length - 1)) * f), f1037b.length - 2);
        float f2 = f1038c;
        float f3 = f1038c;
        return ((f1037b[min + 1] - f1037b[min]) * ((f - (f2 * ((float) min))) / f3)) + f1037b[min];
    }
}
