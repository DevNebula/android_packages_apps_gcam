...
public final class amm {
    ...
    /* renamed from: e */
    private static final Queue f532e = arq.m677a(0);
    /* renamed from: f */
    ...
    public amm(List list, DisplayMetrics displayMetrics, agw agw, agu agu) {
        this.f536i = list;
        this.f534g = (DisplayMetrics) aqe.m610a((Object) displayMetrics, "Argument must not be null");
        this.f533f = (agw) aqe.m610a((Object) agw, "Argument must not be null");
        this.f535h = (agu) aqe.m610a((Object) agu, "Argument must not be null");
    }

    /* renamed from: a */
    public final agn mo370a(InputStream inputStream, int i, int i2, adp adp, amo amo) {
        Object obj;
        long a;
        int i3;
        int i4;
        ...
        String valueOf;
        Bitmap a5;
        aqe.m613a(inputStream.markSupported(), "You must provide an InputStream that supports mark()");
        Object obj2 = (byte[]) this.f535h.mo272a(65536, byte[].class);
        Options c = amm.m349c();
        c.inTempStorage = obj2;
        adg adg = (adg) adp.mo11616a(f528a);
        amf amf = (amf) adp.mo11616a(amf.f527f);
        boolean booleanValue = ((Boolean) adp.mo11616a(f531d)).booleanValue();
        if (adp.mo11616a(f529b) != null) {
            if (((Boolean) adp.mo11616a(f529b)).booleanValue()) {
                obj = 1;
            } else {
                obj = null;
            }
        ...
        try {
            ...
            a2 = adk.m162a(this.f536i, inputStream, this.f535h);
            a3 = anb.m363a(a2);
            boolean b2 = anb.m370b(a2);
            ...
            if (i3 > 0 && i4 > 0) {
                float a6;
                if (a3 == 90 || a3 == MediaDecoder.ROTATE_90_LEFT) {
                    a6 = amf.mo368a(i4, i3, i5, i6);
                } else {
                    a6 = amf.mo368a(i3, i4, i5, i6);
                }
                if (a6 <= 0.0f) {
                    valueOf2 = String.valueOf(amf);
                    stringBuilder = new StringBuilder(String.valueOf(valueOf2).length() + 118);
                ...
                float f = (float) i3;
                float f2 = (float) i4;
                a3 = i3 / ((int) (((double) (a6 * f)) + 0.5d));
                int i8 = i4 / ((int) (((double) (a6 * f2)) + 0.5d));
                if (a7 == C0252go.f5935g) {
                    a3 = Math.max(a3, i8);
                } else {
                    a3 = Math.min(a3, i8);
                }
                a3 = Math.max(1, Integer.highestOneBit(a3));
                if (a7 != C0252go.f5935g) {
                    a7 = a3;
                } else if (((float) a3) < 1.0f / a6) {
                    a7 = a3 + a3;
                } else {
                    a7 = a3;
                }
                ...
                if (b3 == ImageType.JPEG) {
                    ...
                    a3 = (int) Math.ceil((double) (f2 / min));
                    i7 = a7 / 8;
                    if (i7 > 0) {
                        ceil /= i7;
                        a3 /= i7;
                ...
                double a8 = (double) amf.mo368a(ceil, a3, i5, i6);
                if (VERSION.SDK_INT >= 19) {
                    a4 = amm.m341a(a8);
                    i7 = (int) ((((double) a4) * a8) + 0.5d);
                    c.inTargetDensity = (int) (((a8 / ((double) (((float) i7) / ((float) a4)))) * ((double) i7)) + 0.5d);
                ...
                if (Log.isLoggable("Downsampler", 2)) {
                    a4 = c.inTargetDensity;
                    i7 = c.inDensity;
                    StringBuilder stringBuilder2 = new StringBuilder(309);
                    ...
                    stringBuilder2.append(a7);
                    stringBuilder2.append(", adjusted scale factor: ");
                    stringBuilder2.append(a8);
                ...
                valueOf2 = String.valueOf(b3);
                stringBuilder = new StringBuilder(String.valueOf(valueOf2).length() + 74);
            ...
            if (obj3 == null) {
                ...
                obj4 = i5 >= 128 ? i6 >= 128 ? amu.mo373b() ? 1 : null : null : null;
                if (obj4 != null) {
            ...
            if (Log.isLoggable("Downsampler", 3)) {
                valueOf = String.valueOf(adg);
                stringBuilder = new StringBuilder(String.valueOf(valueOf).length() + 72);
        ...
        if (c.inSampleSize == 1 || obj5 != null) {
            if (i3 < 0 || i4 < 0 || !booleanValue || a4 < 19) {
                if (amm.m345a(c)) {
                ...
                a4 = Math.round(((float) ((int) ceil2)) * min);
            ...
            if (a3 > 0 && a4 > 0) {
                ...
                if (c.inPreferredConfig != Config.HARDWARE) {
                    ...
                    c.inBitmap = agw2.mo285b(a3, a4, config);
                }
            }
        }
        Bitmap a9 = amm.m342a(inputStream, c, amo, this.f533f);
        amo.mo372a(this.f533f, a9);
        if (Log.isLoggable("Downsampler", 2)) {
            valueOf = amm.m343a(a9);
            String a10 = amm.m343a(c.inBitmap);
            ceil = c.inSampleSize;
            i6 = c.inDensity;
            i5 = c.inTargetDensity;
            String name = Thread.currentThread().getName();
            double a11 = arm.m654a(a);
            StringBuilder stringBuilder4 = new StringBuilder((((String.valueOf(valueOf).length() + 208) + String.valueOf(str).length()) + String.valueOf(a10).length()) + String.valueOf(name).length());
        ...
        if (a9 != null) {
            ...
            a5 = anb.m365a(this.f533f, a9, a2);
            if (!a9.equals(a5)) {
                this.f533f.mo284a(a9);
            }
        } else {
            a5 = null;
        }
        agn a12 = alv.m6679a(a5, this.f533f);
        amm.m346b(c);
        this.f535h.mo276a(obj2);
        return a12;
    }
