...
/* compiled from: PG */
/* renamed from: io */
public class C0292io {
    /* renamed from: a */
    private final LinkedHashMap f7557a;
    /* renamed from: b */
    private int f7558b;
    /* renamed from: c */
    private int f7559c;
    ...
    public C0292io(int i) {
        if (i <= 0) {
            throw new IllegalArgumentException("maxSize <= 0");
        }
        this.f7559c = i;
        this.f7557a = new LinkedHashMap(0, 0.75f, true);
    }

    /* renamed from: a */
    public final Object mo8653a(Object obj) {
        if (obj == null) {
            throw new NullPointerException("key == null");
        }
        synchronized (this) {
            Object obj2 = this.f7557a.get(obj);
            if (obj2 != null) {
                this.f7562f++;
                return obj2;
            }
     ...
     */
    /* renamed from: a */
    public final java.lang.Object mo8654a(java.lang.Object r5, java.lang.Object r6) {
        /*
        r4 = this;
    ...
    L_0x000c:
        monitor-enter(r4);
        r0 = r4.f7560d;	 Catch:{ all -> 0x0095 }
        r0 = r0 + 1;
        r4.f7560d = r0;	 Catch:{ all -> 0x0095 }
        r0 = r4.f7558b;	 Catch:{ all -> 0x0095 }
        r0 = r0 + 1;
        r4.f7558b = r0;	 Catch:{ all -> 0x0095 }
        r0 = r4.f7557a;	 Catch:{ all -> 0x0095 }
    ...
    L_0x002a:
        monitor-enter(r4);
        r0 = r4.f7558b;	 Catch:{ all -> 0x005a }
        if (r0 < 0) goto L_0x003b;
    L_0x002f:
        r0 = r4.f7557a;	 Catch:{ all -> 0x005a }
    ...
    L_0x006b:
        ...
        r0 = r4.f7558b;	 Catch:{ all -> 0x005a }
        r0 = r0 + -1;
        r4.f7558b = r0;	 Catch:{ all -> 0x005a }
        r0 = r4.f7561e;	 Catch:{ all -> 0x005a }
        r0 = r0 + 1;
        r4.f7561e = r0;	 Catch:{ all -> 0x005a }
        monitor-exit(r4);	 Catch:{ all -> 0x005a }
        goto L_0x002a;
    L_0x0095:
        r0 = move-exception;
    ...
    public final synchronized String toString() {
        ...
        synchronized (this) {
            int i2 = this.f7562f;
            int i3 = this.f7563g + i2;
            if (i3 != 0) {
                i = (i2 * 100) / i3;
            }
            format = String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.f7559c), Integer.valueOf(this.f7562f), Integer.valueOf(this.f7563g), Integer.valueOf(i)});
        }
        return format;
    }
}
