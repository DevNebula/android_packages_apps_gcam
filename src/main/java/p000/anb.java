...
public final class anb {
    ...
    public static Bitmap m366a(agw agw, Bitmap bitmap, int i, int i2) {
        ...
        Bitmap a = agw.mo280a(i, i2, anb.m364a(bitmap));
        anb.m367a(bitmap, a);
    ...
    public static Bitmap m371c(agw agw, Bitmap bitmap, int i, int i2) {
        if (bitmap.getWidth() != i || bitmap.getHeight() != i2) {
            ...
            if (bitmap.getWidth() != round || bitmap.getHeight() != round2) {
                Bitmap a = agw.mo280a((int) (((float) bitmap.getWidth()) * min), (int) (((float) bitmap.getHeight()) * min), anb.m364a(bitmap));
                anb.m367a(bitmap, a);
                if (Log.isLoggable("TransformationUtils", 2)) {
    ...
    public static Bitmap m365a(agw agw, Bitmap bitmap, int i) {
        ...
        Bitmap a = agw.mo280a(Math.round(rectF.width()), Math.round(rectF.height()), anb.m364a(bitmap));
