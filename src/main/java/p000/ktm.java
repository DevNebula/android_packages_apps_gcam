...
public final class ktm implements kqz {
    ...
    /* renamed from: a */
    private static String m14220a(String str) {
    ...
    /* renamed from: a */
    public static Object m14218a(Object obj) {
        if (obj != null) {
            return obj;
        }
    ...
    /* renamed from: a */
    public static Object m14219a(Object obj, String str) {
        if (obj != null) {
            return obj;
        }
    ...
    /* renamed from: a */
    public final byte[] mo10235a(byte[] bArr, int i, int i2) {
        return Arrays.copyOfRange(bArr, i, i + i2);
    }

    /* renamed from: b */
    private static String m14227b(String str) {
    ...
    /* renamed from: a */
    private static String m14221a(kqx kqx) {
        kuf kuf = new kuf(kqx);
        StringBuilder stringBuilder = new StringBuilder(kuf.f8939a.mo10227b());
        for (int i = 0; i < kuf.f8939a.mo10227b(); i++) {
            byte a = kuf.f8939a.mo10221a(i);
            switch (a) {
                case (byte) 7:
    ...
    /* renamed from: a */
    public static List m14223a(int i) {
        if (i == 0) {
    ...
    /* renamed from: a */
    public static String m14222a(kvl kvl) {
        String valueOf;
        String str;
        if (kvl == null) {
            return "";
        ...
        StringBuffer stringBuffer = new StringBuffer();
        try {
            ktm.m14224a(null, (Object) kvl, new StringBuffer(), stringBuffer);
            return stringBuffer.toString();
    ...
    /* renamed from: a */
    private static void m14224a(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) {
        if (obj == null) {
            return;
        }
        int modifiers;
        ...
        if (obj instanceof kvl) {
            ...
            if (str != null) {
                ...
                stringBuffer2.append(ktm.m14227b(str));
            ...
            for (Field field : cls.getFields()) {
                ...
                if (!("cachedSize".equals(name2) || (modifiers & 1) != 1 || (modifiers & 8) == 8 || name2.startsWith("_") || name2.endsWith("_"))) {
                    ...
                    if (!type.isArray()) {
                        ktm.m14224a(name2, obj2, stringBuffer, stringBuffer2);
                        ...
                        for (modifiers = 0; modifiers < length; modifiers++) {
                            ktm.m14224a(name2, Array.get(obj2, modifiers), stringBuffer, stringBuffer2);
                        }
                    }
                }
            }
                    ...
                    try {
                        ...
                        if (((Boolean) cls.getMethod(name, new Class[0]).invoke(obj, new Object[0])).booleanValue()) {
                            try {
                                ...
                                ktm.m14224a(substring, cls.getMethod(name, new Class[0]).invoke(obj, new Object[0]), stringBuffer, stringBuffer2);
    ...
    /* renamed from: a */
    private static void m14225a(StringBuilder stringBuilder, int i, String str, Object obj) {
        int i2 = 0;
        if (obj instanceof List) {
            for (Object a : (List) obj) {
                ktm.m14225a(stringBuilder, i, str, a);
            }
        } else if (obj instanceof Map) {
            for (Object a2 : ((Map) obj).entrySet()) {
                ktm.m14225a(stringBuilder, i, str, a2);
            }
        } else {
            int i3;
            ...
            if (obj instanceof String) {
                stringBuilder.append(": \"");
                stringBuilder.append(ktm.m14221a(kqx.m5115a((String) obj)));
                stringBuilder.append('\"');
            } else if (obj instanceof kqx) {
                stringBuilder.append(": \"");
                stringBuilder.append(ktm.m14221a((kqx) obj));
                stringBuilder.append('\"');
            } else if (obj instanceof kry) {
                stringBuilder.append(" {");
                ktm.m14226a((kry) obj, stringBuilder, i + 2);
                stringBuilder.append("\n");
                while (i2 < i) {
                    stringBuilder.append(' ');
                    i2++;
                ...
                i3 = i + 2;
                ktm.m14225a(stringBuilder, i3, Person.KEY_KEY, entry.getKey());
                ktm.m14225a(stringBuilder, i3, "value", entry.getValue());
                stringBuilder.append("\n");
                while (i2 < i) {
                    stringBuilder.append(' ');
                    i2++;
    ...
    /* renamed from: a */
    static void m14226a(kte kte, StringBuilder stringBuilder, int i) {
        int booleanValue;
        ...
        for (String str : treeSet) {
            ...
            if (!(!replaceFirst.endsWith("List") || replaceFirst.endsWith("OrBuilderList") || replaceFirst.equals("List"))) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    ktm.m14225a(stringBuilder, i, ktm.m14220a(valueOf), kry.m18190a(method2, (Object) kte, new Object[0]));
                }
            }
            ...
            if (((Method) hashMap2.get(str2)) != null) {
                ...
                if (method2 != null) {
                    ...
                    kte a = kry.m18190a(method2, (Object) kte, new Object[0]);
                    if (method3 != null) {
                        booleanValue2 = ((Boolean) kry.m18190a(method3, (Object) kte, new Object[0])).booleanValue();
                    } else {
                        if (a instanceof Boolean) {
                            ...
                            booleanValue = a.equals(kqx.f8795a);
                    ...
                    if (booleanValue2) {
                        ktm.m14225a(stringBuilder, i, ktm.m14220a(str4), (Object) a);
                    }
                }
            }
        }
        if (kte instanceof ksb) {
            Iterator c = ((ksb) kte).f26750g.mo10271c();
            while (c.hasNext()) {
                Entry entry = (Entry) c.next();
                int i2 = ((krs) entry.getKey()).f8822b;
                StringBuilder stringBuilder2 = new StringBuilder(13);
                stringBuilder2.append("[");
                stringBuilder2.append(i2);
                stringBuilder2.append("]");
                ktm.m14225a(stringBuilder, i, stringBuilder2.toString(), entry.getValue());
            }
        }
        kuh kuh = ((kry) kte).f26607e;
        if (kuh != null) {
            for (booleanValue = 0; booleanValue < kuh.f8941b; booleanValue++) {
                ktm.m14225a(stringBuilder, i, String.valueOf(kuh.f8942c[booleanValue] >>> 3), kuh.f8943d[booleanValue]);
            }
        }
    }
}
