...
final class coc {
    /* renamed from: a */
    private static final SimpleDateFormat f2410a = new SimpleDateFormat("yyyyMMddHHmmss");

    /* renamed from: a */
    static String m1240a(jip jip, long j) {
        String str;
        String format = f2410a.format(Long.valueOf(j));
