...
public enum hhx {
    ...
    /* renamed from: a */
    public final Drawable mo7878a(Resources resources) {
        return resources.getDrawable(this.f6582q, null);
    }

    /* renamed from: a */
    public static boolean m3205a(hhx hhx, boolean z) {
        if (z) {
            return keu.m13728a(PORTRAIT, PHOTO).contains(hhx);
        }
        return PHOTO.equals(hhx);
    }

    /* renamed from: a */
    public static hhx m3204a(String str) {
