...
public final class bux implements buy {
    /* renamed from: a */
    private final bus f11824a;
    /* renamed from: b */
    private final UriMatcher f11825b;
    /* renamed from: c */
    private final bvm f11826c;

    public bux(bus bus, UriMatcher uriMatcher, bvm bvm) {
        this.f11824a = bus;
        this.f11825b = uriMatcher;
        this.f11826c = bvm;
    }

    /* renamed from: a */
    public final android.database.Cursor mo2160a(android.net.Uri r14, java.lang.String[] r15) {
        /*
        r13 = this;
        r4 = 0;
        r0 = p000.buk.f1625a;
