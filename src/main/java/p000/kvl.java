...
public abstract class kvl {
    ...
    public static final void toByteArray(kvl kvl, byte[] bArr, int i, int i2) {
        try {
            kvd a = kvd.m5482a(bArr, i, i2);
            kvl.writeTo(a);
            if (a.f9011a.remaining() != 0) {
                throw new IllegalStateException(String.format("Did not write as much data as expected, %s bytes remaining.", new Object[]{Integer.valueOf(a.f9011a.remaining())}));
            }
        } catch (Throwable e) {
