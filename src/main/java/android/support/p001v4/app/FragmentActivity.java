...
public class FragmentActivity extends SupportActivity implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator, C0042ap {
    ...
    public final Handler mHandler = new C00121();
    public int mNextCandidateRequestIndex;
    public C0303ja mPendingFragmentActivityResults;
    ...
    public C0041ao mViewModelStore;
    ...
    private int allocateRequestIndex(Fragment fragment) {
        if (this.mPendingFragmentActivityResults.mo9257b() < MAX_NUM_PENDING_FRAGMENT_ACTIVITY_RESULTS) {
            while (true) {
                C0303ja c0303ja = this.mPendingFragmentActivityResults;
                int i = this.mNextCandidateRequestIndex;
                if (c0303ja.f7964b) {
                    c0303ja.mo9255a();
                }
                if (C0289il.m3867a(c0303ja.f7965c, c0303ja.f7967e, i) >= 0) {
                    this.mNextCandidateRequestIndex = (this.mNextCandidateRequestIndex + 1) % MAX_NUM_PENDING_FRAGMENT_ACTIVITY_RESULTS;
                } else {
                    int i2 = this.mNextCandidateRequestIndex;
                    this.mPendingFragmentActivityResults.mo9256a(i2, fragment.mWho);
                    this.mNextCandidateRequestIndex = (this.mNextCandidateRequestIndex + 1) % MAX_NUM_PENDING_FRAGMENT_ACTIVITY_RESULTS;
                    return i2;
                }
            }
    ...
    public C0041ao getViewModelStore() {
        if (getApplication() == null) {
            throw new IllegalStateException("Your activity is not yet attached to the Application instance. You can't request ViewModel before onCreate call.");
        }
        if (this.mViewModelStore == null) {
            this.mViewModelStore = new C0041ao();
        }
    ...
    private void markFragmentsCreated() {
        do {
        } while (FragmentActivity.markState(getSupportFragmentManager(), C0552w.CREATED));
    }

    private static boolean markState(FragmentManager fragmentManager, C0552w c0552w) {
        boolean z = false;
        for (Fragment fragment : fragmentManager.getFragments()) {
            if (fragment != null) {
                if (fragment.getLifecycle().mo11197a().mo11434a(C0552w.STARTED)) {
                    fragment.mLifecycleRegistry.mo14474a(c0552w);
                    z = true;
                }
                FragmentManager peekChildFragmentManager = fragment.peekChildFragmentManager();
                if (peekChildFragmentManager != null) {
                    z = FragmentActivity.markState(peekChildFragmentManager, c0552w) | z;
                }
            }
        }
        return z;
    ...
    protected void onActivityResult(int i, int i2, Intent intent) {
        ...
        i3--;
        C0303ja c0303ja = this.mPendingFragmentActivityResults;
        int a = C0289il.m3867a(c0303ja.f7965c, c0303ja.f7967e, i3);
        if (a >= 0 && c0303ja.f7966d[a] != C0303ja.f7963a) {
            obj = c0303ja.f7966d[a];
        }
        String str = (String) obj;
        c0303ja = this.mPendingFragmentActivityResults;
        i3 = C0289il.m3867a(c0303ja.f7965c, c0303ja.f7967e, i3);
        if (i3 >= 0 && c0303ja.f7966d[i3] != C0303ja.f7963a) {
            c0303ja.f7966d[i3] = C0303ja.f7963a;
            c0303ja.f7964b = true;
        }
        if (str == null) {
    ...
    public void onCreate(Bundle bundle) {
            ...
            if (bundle.containsKey(NEXT_CANDIDATE_REQUEST_INDEX_TAG)) {
                ...
                if (!(intArray == null || stringArray == null)) {
                    ...
                    if (length == stringArray.length) {
                        this.mPendingFragmentActivityResults = new C0303ja(length);
                        for (length = 0; length < intArray.length; length++) {
                            this.mPendingFragmentActivityResults.mo9256a(intArray[length], stringArray[length]);
                        }
                    }
                }
        ...
        if (this.mPendingFragmentActivityResults == null) {
            this.mPendingFragmentActivityResults = new C0303ja();
    ...
    public void onDestroy() {
        super.onDestroy();
        doReallyStop(false);
        C0041ao c0041ao = this.mViewModelStore;
        if (!(c0041ao == null || this.mRetaining)) {
            c0041ao.mo1627a();
        }
    ...
    public void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
        ...
        if (i2 != 0) {
            i2--;
            C0303ja c0303ja = this.mPendingFragmentActivityResults;
            int a = C0289il.m3867a(c0303ja.f7965c, c0303ja.f7967e, i2);
            if (a >= 0 && c0303ja.f7966d[a] != C0303ja.f7963a) {
                obj = c0303ja.f7966d[a];
            }
            String str = (String) obj;
            c0303ja = this.mPendingFragmentActivityResults;
            i2 = C0289il.m3867a(c0303ja.f7965c, c0303ja.f7967e, i2);
            if (i2 >= 0 && c0303ja.f7966d[i2] != C0303ja.f7963a) {
                c0303ja.f7966d[i2] = C0303ja.f7963a;
                c0303ja.f7964b = true;
            }
            if (str == null) {
                Log.w(TAG, "Activity result delivered for unknown Fragment.");
    ...
    public void onSaveInstanceState(Bundle bundle) {
        ...
        if (this.mPendingFragmentActivityResults.mo9257b() > 0) {
            bundle.putInt(NEXT_CANDIDATE_REQUEST_INDEX_TAG, this.mNextCandidateRequestIndex);
            int[] iArr = new int[this.mPendingFragmentActivityResults.mo9257b()];
            String[] strArr = new String[this.mPendingFragmentActivityResults.mo9257b()];
            int i = 0;
            while (true) {
                int i2 = i;
                if (i2 < this.mPendingFragmentActivityResults.mo9257b()) {
                    iArr[i2] = this.mPendingFragmentActivityResults.mo9254a(i2);
                    strArr[i2] = (String) this.mPendingFragmentActivityResults.mo9258b(i2);
                    i = i2 + 1;
                } else {
