...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, OpGenerator {
    ...
    final class C0008Op {
        ...
        C0008Op(int i, Fragment fragment) {
            this.cmd = i;
    ...
    final void addOp(C0008Op c0008Op) {
        this.mOps.add(c0008Op);
    ...
    final void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                C0008Op c0008Op = (C0008Op) this.mOps.get(i2);
                ...
                if (fragment != null) {
                    ...
                    if (FragmentManagerImpl.DEBUG) {
                        ...
                        stringBuilder2.append(c0008Op.fragment);
                        stringBuilder2.append(" to ");
                        stringBuilder2.append(c0008Op.fragment.mBackStackNesting);
    ...
    public final void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                String str2;
                C0008Op c0008Op = (C0008Op) this.mOps.get(i);
                switch (c0008Op.cmd) {
                    case 0:
                        str2 = "NULL";
                        break;
                    ...
                    default:
                        ...
                        stringBuilder2.append(c0008Op.cmd);
    ...
    final void executeOps() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (c0008Op.cmd) {
                case 1:
                    fragment.setNextAnim(c0008Op.enterAnim);
                    this.mManager.addFragment(fragment, false);
                    break;
                case 3:
                    fragment.setNextAnim(c0008Op.exitAnim);
                ...
                default:
                    ...
                    stringBuilder.append(c0008Op.cmd);
                    throw new IllegalArgumentException(stringBuilder.toString());
            }
            if (!(this.mReorderingAllowed || c0008Op.cmd == 1 || fragment == null)) {
    ...
    final void executePopOps(boolean z) {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            C0008Op c0008Op = (C0008Op) this.mOps.get(size);
            Fragment fragment = c0008Op.fragment;
            if (fragment != null) {
            ...
            switch (c0008Op.cmd) {
                case 1:
                    fragment.setNextAnim(c0008Op.popExitAnim);
                    this.mManager.removeFragment(fragment);
                    break;
                case 3:
                    fragment.setNextAnim(c0008Op.popEnterAnim);
                    this.mManager.addFragment(fragment, false);
                    break;
                case 4:
                    fragment.setNextAnim(c0008Op.popEnterAnim);
            ...
            if (!(this.mReorderingAllowed || c0008Op.cmd == 3 || fragment == null)) {
                this.mManager.moveFragmentToExpectedState(fragment);
            }
        }
    ...
    final Fragment expandOps(ArrayList arrayList, Fragment fragment) {
        ...
        while (i < this.mOps.size()) {
            ...
            switch (c0008Op.cmd) {
                case 1:
                case 7:
                    arrayList.add(c0008Op.fragment);
                    break;
                case 2:
                    ...
                    while (size >= 0) {
                        ...
                        if (fragment3.mContainerId != i2) {
                            ...
                            if (fragment3 == fragment) {
                                this.mOps.add(i4, new C0008Op(9, fragment3));
                                i4++;
                                fragment = null;
                            }
                            C0008Op c0008Op2 = new C0008Op(3, fragment3);
                            c0008Op2.enterAnim = c0008Op.enterAnim;
                            c0008Op2.popEnterAnim = c0008Op.popEnterAnim;
                            c0008Op2.exitAnim = c0008Op.exitAnim;
                            c0008Op2.popExitAnim = c0008Op.popExitAnim;
                            this.mOps.add(i4, c0008Op2);
                ...
                case 3:
                case 6:
                    arrayList.remove(c0008Op.fragment);
                    Fragment fragment4 = c0008Op.fragment;
                    if (fragment4 != fragment) {
                        break;
                    }
                    this.mOps.add(i, new C0008Op(9, fragment4));
                    i++;
                    fragment = null;
                    break;
                case 8:
                    this.mOps.add(i, new C0008Op(9, fragment));
                    i++;
                    fragment = c0008Op.fragment;
                    break;
                default:
                    break;
            }
    ...
    final boolean interactsWith(int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            int i3;
            Fragment fragment = ((C0008Op) this.mOps.get(i2)).fragment;
            if (fragment != null) {
    ...
    final boolean interactsWith(ArrayList arrayList, int i, int i2) {
        ...
        while (i4 < size) {
            int i5;
            int i6;
            Fragment fragment = ((C0008Op) this.mOps.get(i4)).fragment;
            if (fragment != null) {
            ...
            if (i5 == 0) {
                ...
                for (int i7 = i; i7 < i2; i7++) {
                    ...
                    for (int i8 = 0; i8 < size2; i8++) {
                        Fragment fragment2 = ((C0008Op) backStackRecord.mOps.get(i8)).fragment;
                        if (fragment2 != null) {
    ...
    private static boolean isFragmentPostponed(C0008Op c0008Op) {
        Fragment fragment = c0008Op.fragment;
    ...
    final boolean isPostponed() {
        for (int i = 0; i < this.mOps.size(); i++) {
            if (BackStackRecord.isFragmentPostponed((C0008Op) this.mOps.get(i))) {
                return true;
            }
        }
        return false;
    ...
    final void setOnStartPostponedListener(OnStartEnterTransitionListener onStartEnterTransitionListener) {
        ...
        while (true) {
            ...
            if (i2 < this.mOps.size()) {
                C0008Op c0008Op = (C0008Op) this.mOps.get(i2);
                if (BackStackRecord.isFragmentPostponed(c0008Op)) {
                    c0008Op.fragment.setOnStartEnterTransitionListener(onStartEnterTransitionListener);
                }
                i = i2 + 1;
            } else {
                return;
