...
public abstract class JobIntentService extends Service {
     ...
     */
        /* JADX WARNING: Missing block: B:19:?, code:
            return new android.support.p001v4.app.JobIntentService.JobServiceEngineImpl.WrapperWorkItem(r3, r2);
     */
        public final android.support.p001v4.app.JobIntentService.GenericWorkItem dequeueWork() {
            /*
            r3 = this;
            r0 = 0;
            r1 = r3.mLock;
    ...
    public static void enqueueWork(Context context, ComponentName componentName, int i, Intent intent) {
        ...
        synchronized (sLock) {
            WorkEnqueuer workEnqueuer = JobIntentService.getWorkEnqueuer(context, componentName, true, i);
    ...
    public static void enqueueWork(Context context, Class cls, int i, Intent intent) {
        JobIntentService.enqueueWork(context, new ComponentName(context, cls), i, intent);
    }
