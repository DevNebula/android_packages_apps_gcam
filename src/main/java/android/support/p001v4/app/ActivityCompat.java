...
public class ActivityCompat extends C0242ge {
    ...
    public static C0241gb requestDragAndDropPermissions(Activity activity, DragEvent dragEvent) {
        return activity.requestDragAndDropPermissions(dragEvent) != null ? new C0241gb() : null;
    }
