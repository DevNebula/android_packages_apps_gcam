...
public class ActionBarDrawerToggle implements C0347ld {
    ...
    public final C0345kz mDrawerLayout;
    ...
    class SlideDrawable extends InsetDrawable implements Callback {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.save();
            int j = C0315jm.m4635j(ActionBarDrawerToggle.this.mActivity.getWindow().getDecorView());
            if (j == 1) {
                i = -1;
            } else {
                i = 1;
    ...
    public ActionBarDrawerToggle(Activity activity, C0345kz c0345kz, int i, int i2, int i3) {
        this(activity, c0345kz, ActionBarDrawerToggle.assumeMaterial(activity) ^ 1, i, i2, i3);
    }

    public ActionBarDrawerToggle(Activity activity, C0345kz c0345kz, boolean z, int i, int i2, int i3) {
        float f;
        ...
        this.mDrawerLayout = c0345kz;
        this.mDrawerImageResource = i;
        this.mOpenDrawerContentDescRes = i2;
        this.mCloseDrawerContentDescRes = i3;
        this.mHomeAsUpIndicator = getThemeUpIndicator();
        this.mDrawerImage = C0242ge.getDrawable(activity, i);
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.mDrawerImage = C0242ge.getDrawable(this.mActivity, this.mDrawerImageResource);
        syncState();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        View a = this.mDrawerLayout.mo10570a(8388611);
        if (a != null) {
            z = C0345kz.m5550g(a);
        }
        if (z) {
            this.mDrawerLayout.mo10571a();
        } else {
            this.mDrawerLayout.mo10585d();
        }
        return true;
    }
    ...
    public void setDrawerIndicatorEnabled(boolean z) {
        if (z != this.mDrawerIndicatorEnabled) {
            if (z) {
                ...
                if (this.mDrawerLayout.mo10582c()) {
    ...
    public void setHomeAsUpIndicator(int i) {
        Drawable drawable;
        if (i != 0) {
            drawable = C0242ge.getDrawable(this.mActivity, i);
        } else {
            drawable = null;
        }
