...
final class FragmentState implements Parcelable {
    public static final Creator CREATOR = new C00191();
    ...
    final class C00191 implements Creator {
        C00191() {
        }
    ...
    public final Fragment instantiate(FragmentHostCallback fragmentHostCallback, FragmentContainer fragmentContainer, Fragment fragment, FragmentManagerNonConfig fragmentManagerNonConfig, C0041ao c0041ao) {
        Fragment fragment2;
        ...
        fragment2.mViewModelStore = c0041ao;
        return fragment2;
    }
