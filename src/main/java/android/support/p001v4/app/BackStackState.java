...
final class BackStackState implements Parcelable {
    ...
    public BackStackState(BackStackRecord backStackRecord) {
        ...
        if (backStackRecord.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                C0008Op c0008Op = (C0008Op) backStackRecord.mOps.get(i2);
                int[] iArr = this.mOps;
                int i3 = i + 1;
                iArr[i] = c0008Op.cmd;
                int i4 = i3 + 1;
                ...
                iArr[i3] = i;
                i = i4 + 1;
                iArr[i4] = c0008Op.enterAnim;
                i3 = i + 1;
                iArr[i] = c0008Op.exitAnim;
                i4 = i3 + 1;
                iArr[i3] = c0008Op.popEnterAnim;
                i = i4 + 1;
                iArr[i4] = c0008Op.popExitAnim;
            }
    ...
    public final BackStackRecord instantiate(FragmentManagerImpl fragmentManagerImpl) {
        ...
        while (i < this.mOps.length) {
            ...
            i = this.mOps[i3];
            if (i >= 0) {
                c0008Op.fragment = (Fragment) fragmentManagerImpl.mActive.get(i);
            } else {
                c0008Op.fragment = null;
            }
            int[] iArr = this.mOps;
            i3 = i4 + 1;
            c0008Op.enterAnim = iArr[i4];
            i4 = i3 + 1;
            c0008Op.exitAnim = iArr[i3];
            int i5 = i4 + 1;
            c0008Op.popEnterAnim = iArr[i4];
            i3 = i5 + 1;
            c0008Op.popExitAnim = iArr[i5];
            backStackRecord.mEnterAnim = c0008Op.enterAnim;
            backStackRecord.mExitAnim = c0008Op.exitAnim;
            backStackRecord.mPopEnterAnim = c0008Op.popEnterAnim;
            backStackRecord.mPopExitAnim = c0008Op.popExitAnim;
            backStackRecord.addOp(c0008Op);
            i2++;
            i = i3;
        }
