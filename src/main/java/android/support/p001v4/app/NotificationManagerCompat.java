...
public final class NotificationManagerCompat {
    ...
    class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) {
            if (this.all) {
                ...
                iNotificationSideChannel.cancel(this.packageName, this.f559id, this.tag);
            }
        }
        ...
        public String toString() {
            ...
            stringBuilder.append(this.f559id);
    ...
    class NotifyTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) {
            iNotificationSideChannel.notify(this.packageName, this.f560id, this.tag, this.notif);
        }
        ...
        public String toString() {
            ...
            stringBuilder.append(this.packageName);
            stringBuilder.append(", id:");
            stringBuilder.append(this.f560id);
            stringBuilder.append(", tag:");
            stringBuilder.append(this.tag);
            stringBuilder.append("]");
            return stringBuilder.toString();
