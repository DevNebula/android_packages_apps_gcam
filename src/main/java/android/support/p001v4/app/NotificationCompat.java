...
public class NotificationCompat {
    ...
    public class Style {
        ...
        private int calculateTopPadding() {
            ...
            float constrain = (Style.constrain(resources.getConfiguration().fontScale, 1.0f, 1.3f) - 4.0f) / 0.29999995f;
    ...
    public final class CarExtender implements Extender {
        ...
        public CarExtender(Notification notification) {
            ...
            if (bundle != null) {
                ...
                this.mUnreadConversation = CarExtender.getUnreadConversationFromBundle(bundle.getBundle(EXTRA_CONVERSATION));
            }
        }
        ...
        public final Builder extend(Builder builder) {
            ...
            if (unreadConversation != null) {
                bundle.putBundle(EXTRA_CONVERSATION, CarExtender.getBundleForUnreadConversation(unreadConversation));
            }
        ...
        private static Bundle getBundleForUnreadConversation(UnreadConversation unreadConversation) {
            ...
            if (remoteInput != null) {
                bundle.putParcelable(KEY_REMOTE_INPUT, new Builder(remoteInput.getResultKey()).setLabel(remoteInput.getLabel()).setChoices(remoteInput.getChoices()).setAllowFreeFormInput(remoteInput.getAllowFreeFormInput()).addExtras(remoteInput.getExtras()).build());
            }
    ...
    public class MessagingStyle extends Style {
        ...
        public final class Message {
            ...
            static Message getMessageFromBundle(Bundle bundle) {
                try {
                    ...
                    Person fromBundle = bundle.containsKey(KEY_PERSON) ? Person.fromBundle(bundle.getBundle(KEY_PERSON)) : bundle.containsKey(KEY_SENDER) ? new Person.Builder().setName(bundle.getCharSequence(KEY_SENDER)).build() : null;
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            for (Message message : this.mMessages) {
                ...
                Message message2 = new Message(message.getText(), message.getTimestamp(), name);
        ...
        private CharSequence makeMessageLine(Message message) {
            ...
            spannableStringBuilder.append("  ").append(a.mo8262a(text));
    ...
    public final class WearableExtender implements Extender {
                ...
                if (parcelableArrayList != null) {
                    ...
                    for (int i = 0; i < actionArr.length; i++) {
                        if (VERSION.SDK_INT >= 20) {
                            actionArr[i] = NotificationCompat.getActionCompatFromAction((Action) parcelableArrayList.get(i));
                        } else {
        ...
        public final Builder extend(Builder builder) {
            ...
            if (!this.mActions.isEmpty()) {
                ...
                while (i < size) {
                    int i2 = i + 1;
                    arrayList.add(WearableExtender.getActionFromActionCompat((Action) arrayList2.get(i)));
                    i = i2;
                }
        ...
        private static Action getActionFromActionCompat(Action action) {
            Bundle bundle;
            Action.Builder builder = new Action.Builder(action.getIcon(), action.getTitle(), action.getActionIntent());
    ...
    public static Action getAction(Notification notification, int i) {
        return NotificationCompat.getActionCompatFromAction(notification.actions[i]);
    }

    static Action getActionCompatFromAction(Action action) {
        RemoteInput[] remoteInputArr;
        boolean z;
        int semanticAction;
        RemoteInput[] remoteInputs = action.getRemoteInputs();
    ...
    static Notification[] getNotificationArrayFromBundle(Bundle bundle, String str) {
        ...
        while (true) {
            ...
            if (i2 < parcelableArray.length) {
                parcelableArr[i2] = (Notification) parcelableArray[i2];
                i = i2 + 1;
            } else {
