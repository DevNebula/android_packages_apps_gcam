...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener, C0042ap, C0587y {
    ...
    public static final C0301iz sClassMap = new C0301iz();
    ...
    public View mView;
    public C0587y mViewLifecycleOwner;
    public C0629ah mViewLifecycleOwnerLiveData = new C0629ah();
    public C0801z mViewLifecycleRegistry;
    ...
    class C06312 extends FragmentContainer {
        C06312() {
        }
    ...
    class C06323 implements C0587y {
        C06323() {
        }
        ...
        public C0510u getLifecycle() {
            if (Fragment.this.mViewLifecycleRegistry == null) {
                ...
                fragment.mViewLifecycleRegistry = new C0801z(fragment.mViewLifecycleOwner);
            }
    ...
    public C0587y getViewLifecycleOwner() {
        C0587y c0587y = this.mViewLifecycleOwner;
        if (c0587y != null) {
            return c0587y;
        }
    ...
    public C0000ac getViewLifecycleOwnerLiveData() {
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachController(this.mHost, new C06312(), this);
    }
    ...
    public void onDestroy() {
        ...
        if (c0041ao != null && !this.mHost.mFragmentManager.mStateSaved) {
            c0041ao.mo1627a();
        }
    }
    ...
    public void onDestroyView() {
        this.mCalled = true;
        if (this.mView != null) {
            this.mViewLifecycleRegistry.mo14475b(C0531v.ON_DESTROY);
        }
    }
    ...
    public void onViewStateRestored(Bundle bundle) {
        this.mCalled = true;
        if (this.mView != null) {
            this.mViewLifecycleRegistry.mo14475b(C0531v.ON_CREATE);
        }
    }
    ...
    void performCreate(Bundle bundle) {
        ...
        if (this.mCalled) {
            this.mLifecycleRegistry.mo14475b(C0531v.ON_CREATE);
            return;
        }
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Fragment ");
    ...
    void performCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mViewLifecycleOwner = new C06323();
    ...
    void performDestroy() {
        this.mLifecycleRegistry.mo14475b(C0531v.ON_DESTROY);
        FragmentManagerImpl fragmentManagerImpl = this.mChildFragmentManager;
        if (fragmentManagerImpl != null) {
    ...
    void performPause() {
        if (this.mView != null) {
            this.mViewLifecycleRegistry.mo14475b(C0531v.ON_PAUSE);
        }
        this.mLifecycleRegistry.mo14475b(C0531v.ON_PAUSE);
        FragmentManagerImpl fragmentManagerImpl = this.mChildFragmentManager;
        if (fragmentManagerImpl != null) {
    ...
    void performResume() {
        ...
        if (this.mCalled) {
            ...
            this.mLifecycleRegistry.mo14475b(C0531v.ON_RESUME);
            if (this.mView != null) {
                this.mViewLifecycleRegistry.mo14475b(C0531v.ON_RESUME);
                return;
            }
            return;
        }
    ...
    void performStart() {
        ...
        if (this.mCalled) {
            ...
            this.mLifecycleRegistry.mo14475b(C0531v.ON_START);
            if (this.mView != null) {
                this.mViewLifecycleRegistry.mo14475b(C0531v.ON_START);
                return;
            }
            return;
        }
    ...
    void performStop() {
        this.mLifecycleRegistry.mo14475b(C0531v.ON_STOP);
        FragmentManagerImpl fragmentManagerImpl = this.mChildFragmentManager;
        if (fragmentManagerImpl != null) {
    ...
    public void startPostponedEnterTransition() {
        ...
        if (fragmentManagerImpl == null || fragmentManagerImpl.mHost == null) {
            ...
            this.mFragmentManager.mHost.getHandler().postAtFrontOfQueue(new C00101());
        } else {
