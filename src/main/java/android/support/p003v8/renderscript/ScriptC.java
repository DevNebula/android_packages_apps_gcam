...
public class ScriptC extends Script {
    ...
    protected ScriptC(RenderScript renderScript, Resources resources, int i) {
        ...
        long internalCreate = ScriptC.internalCreate(renderScript, resources, i);
        if (internalCreate == 0) {
    ...
    public ScriptC(RenderScript renderScript, String str, byte[] bArr, byte[] bArr2) {
        ...
        if (RenderScript.sPointerSize == 4) {
            internalStringCreate = ScriptC.internalStringCreate(renderScript, str, bArr);
        } else {
            internalStringCreate = ScriptC.internalStringCreate(renderScript, str, bArr2);
        }
