...
import android.support.p003v8.renderscript.Element.DataKind;
import android.support.p003v8.renderscript.Element.DataType;
import android.support.p003v8.renderscript.Type.Builder;
import android.support.p003v8.renderscript.Type.CubemapFace;
...
public class Allocation extends BaseObj {
    ...
    public static Allocation createCubemapFromBitmap(RenderScript renderScript, Bitmap bitmap, MipmapControl mipmapControl, int i) {
        ...
        if (width % 6 != 0) {
            ...
            Element elementFromBitmap = Allocation.elementFromBitmap(renderScript, bitmap);
    ...
    public static Allocation createFromBitmap(RenderScript renderScript, Bitmap bitmap, MipmapControl mipmapControl, int i) {
        while (true) {
            ...
            if (bitmap2.getConfig() != null) {
                Type typeFromBitmap = Allocation.typeFromBitmap(renderScript, bitmap2, mipmapControl);
    ...
    public static Allocation createFromBitmapResource(RenderScript renderScript, Resources resources, int i) {
        return Allocation.createFromBitmapResource(renderScript, resources, i, MipmapControl.MIPMAP_NONE, 3);
    }
    ...
    public static Allocation createFromBitmapResource(RenderScript renderScript, Resources resources, int i, MipmapControl mipmapControl, int i2) {
        ...
        Allocation createFromBitmap = Allocation.createFromBitmap(renderScript, decodeResource, mipmapControl, i2);
    ...
    public static Allocation createFromString(RenderScript renderScript, String str, int i) {
        ...
        try {
            ...
            Allocation createSized = Allocation.createSized(renderScript, Element.m6892U8(renderScript), bytes.length, i);
    ...
    public static Allocation createSized(RenderScript renderScript, Element element, int i) {
        return Allocation.createSized(renderScript, element, i, 1);
    }
    ...
    public static Allocation createTyped(RenderScript renderScript, Type type, int i) {
        return Allocation.createTyped(renderScript, type, MipmapControl.MIPMAP_NONE, i);
    }
    ...
    static Type typeFromBitmap(RenderScript renderScript, Bitmap bitmap, MipmapControl mipmapControl) {
        boolean z;
        Builder builder = new Builder(renderScript, Allocation.elementFromBitmap(renderScript, bitmap));
    ...
    private void validateBitmapFormat(Bitmap bitmap) {
        ...
        switch (C00371.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()]) {
            case 1:
