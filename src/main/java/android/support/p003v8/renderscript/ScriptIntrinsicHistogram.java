...
public class ScriptIntrinsicHistogram extends ScriptIntrinsic {
    ...
    public static ScriptIntrinsicHistogram create(RenderScript renderScript, Element element) {
        if (element.isCompatible(Element.U8_4(renderScript)) || element.isCompatible(Element.U8_3(renderScript)) || element.isCompatible(Element.U8_2(renderScript)) || element.isCompatible(Element.m6892U8(renderScript))) {
    ...
    public void forEach(Allocation allocation, LaunchOptions launchOptions) {
        ...
        } else if (allocation.getType().getElement().isCompatible(Element.m6892U8(this.mRS)) || allocation.getType().getElement().isCompatible(Element.U8_2(this.mRS)) || allocation.getType().getElement().isCompatible(Element.U8_3(this.mRS)) || allocation.getType().getElement().isCompatible(Element.U8_4(this.mRS))) {
